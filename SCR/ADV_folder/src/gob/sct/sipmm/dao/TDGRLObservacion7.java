 ...
 * @version 1.0
 */
public class TDGRLObservacion7 extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      Vector vcdData = findByCustom(""," select * from CVHRepEquipoNav  where "+
      ...
      TDCVHRepEquipoNav dCVHDatosCalifica = new TDCVHRepEquipoNav();
