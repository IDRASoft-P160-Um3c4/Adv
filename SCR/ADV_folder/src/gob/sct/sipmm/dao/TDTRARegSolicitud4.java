...
/**
 * <p>Title: TDTRARegSolicitud4.java</p>
 ...
 * @version 1.0
 */
public class TDTRARegSolicitud4 extends DAOBase{
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update TRARegSolicitud set iCveTramite=?, iCveModalidad=?, iCveSolicitante=?, iCveRepLegal=?, cNomAutorizaRecoger=?, iCveUsuRegistra=?, tsRegistro=?, dtLimiteEntregaDocs=?, dtEstimadaEntrega=?, lPagado=?, dtEntrega=(current Date), iCveUsuEntrega=?, lResolucionPositiva=?, lDatosPreregistro=?, iIdBien=?, iCveOficina=?, iCveDepartamento=?, iEjercicioCita=?, iIdCita=?, iCveForma=?, lPrincipal=? where iEjercicio = ? AND iNumSolicitud = ? ";
      ...
      lPStmt.setInt(11,vData.getInt("iCveUsuEntrega"));
      lPStmt.setInt(12,vData.getInt("lResolucionPositiva"));
      lPStmt.setInt(13,vData.getInt("lDatosPreregistro"));
      lPStmt.setInt(14,vData.getInt("iIdBien"));
      lPStmt.setInt(15,vData.getInt("iCveOficina"));
      lPStmt.setInt(16,vData.getInt("iCveDepartamento"));
      lPStmt.setInt(17,vData.getInt("iEjercicioCita"));
      lPStmt.setInt(18,vData.getInt("iIdCita"));
      lPStmt.setInt(19,vData.getInt("iCveForma"));
      lPStmt.setInt(20,vData.getInt("lPrincipal"));
      lPStmt.setInt(21,vData.getInt("iEjercicio"));
      lPStmt.setInt(22,vData.getInt("iNumSolicitud"));
      lPStmt.executeUpdate();
      if(cnNested == null){
        conn.commit();
      }
 ...
 public TVDinRep updEntrega(TVDinRep vData,Connection cnNested) throws
    DAOException{
  DbConnection dbConn = null;
  Connection conn = cnNested;
  PreparedStatement lPStmt = null;
  ...
  try{
    ...
    String lSQL = "update TRARegSolicitud " +
                  "set dtEntrega=(current Date), " +
                  "iCveUsuEntrega=? " +
                  "where iEjercicio = ? " +
                  "AND iNumSolicitud = ? ";
    ...
    lPStmt = conn.prepareStatement(lSQL);
    lPStmt.setInt(1,vData.getInt("iCveUsuEntrega"));
