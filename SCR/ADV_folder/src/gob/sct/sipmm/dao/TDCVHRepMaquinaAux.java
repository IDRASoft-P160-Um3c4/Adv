...
/**
 * <p>Title: TDCVHRepMaquinaAux.java</p>
 * <p>Description: DAO de la entidad CVHRepMaquinaAux</p>
 * <p>Copyright: Copyright (c) 2005 </p>
 * <p>Company: Tecnología InRed S.A. de C.V. </p>
 * @author Hanksel Fierro Medina<dd>Rafael Miranda Blumenkron
 * @version 1.0
 */
public class TDCVHRepMaquinaAux
    extends DAOBase{
   ...
   * <p><b> insert into CVHRepMaquinaAux(iCveVehiculo,iEjercicioReporte,iMesReporte,iCveUsuRegistra,dtRegistro,iEjercicioObs,iCveObservacion,lConcluido,iCveUsuValida,dtValidacion) values (?,?,?,?,?,?,?,?,?,?) </b></p>
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL =
          "insert into CVHRepMaquinaAux(iCveVehiculo,iEjercicioReporte,iMesReporte,iCveUsuRegistra,dtRegistro,iEjercicioObs,iCveObservacion) values (?,?,?,?,(CURRENT DATE),YEAR(CURRENT DATE),?)";

      //AGREGAR AL ULTIMO ...
      //...
      Vector vcData = findByCustom(""," select * from CVHRepMaquinaAux  where " +
      ...
      if(vcData.size() == 0){
        ...
        //lPStmt.setInt(5,vData.getInt("iEjercicioObs"));
        lPStmt.setInt(5,vData.getInt("iCveObservacion"));

        lPStmt.executeUpdate();

        TDCVHDatosRepMaqAux dCVHDatosCalifica = new TDCVHDatosRepMaqAux();
   ...
   * <p><b> delete from CVHRepMaquinaAux where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ?  </b></p>
   * <p><b> Campos Llave: iCveVehiculo,iEjercicioReporte,iMesReporte, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public boolean delete(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "delete from CVHRepMaquinaAux where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ?  ";
      //...
   ...
   * <p><b> update CVHRepMaquinaAux set iCveUsuRegistra=?, dtRegistro=?, iEjercicioObs=?, iCveObservacion=?, lConcluido=?, iCveUsuValida=?, dtValidacion=? where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ?  </b></p>
   * <p><b> Campos Llave: iCveVehiculo,iEjercicioReporte,iMesReporte, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update CVHRepMaquinaAux set  lConcluido=1, iCveUsuValida=?, dtValidacion=(CURRENT DATE) where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ? ";
      ...
      //lPStmt.setDate(7,vData.getDate("dtValidacion"));
  ...
  public TVDinRep insertUpdateBatch(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      int iEjercicioObs = 0,
        iCveObservacion = 0;
      TDCVHDatosRepMaqAux dDatosRepMaqAux = new TDCVHDatosRepMaqAux();
      if(cnNested == null){
        dbConn = new DbConnection(dataSourceName);
        conn = dbConn.getConnection();
        conn.setAutoCommit(false);
      ...
      if(vData.getString("cObsRegistrada") !=  null && !vData.getString("cObsRegistrada").equals("")){
        try{
          if(vData.getInt("iEjercicioObs") <=0)
            vDataObs.put("iEjercicio", vData.getInt("iEjercicioReporte"));
          else
      ...
      if(vcData.size() == 0){
        String lSQL = "insert into CVHRepMaquinaAux(iCveVehiculo,iEjercicioReporte,iMesReporte," +
        ...
        String lSQL = "update CVHRepMaquinaAux set iEjercicioObs=?,"+
      ...
      try{
        dDatosRepMaqAux.insertUpdateBatch(vData,conn);
      }catch(Exception e){
        e.printStackTrace();
      }
      if(cnNested == null)
  ...
  public TVDinRep concluyeReporte(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update CVHRepMaquinaAux set lConcluido=?, iCveUsuRegistra=?, dtRegistro=? where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ? ";
  ...
  public TVDinRep validaConcluye(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update CVHRepMaquinaAux set lConcluido=?, iCveUsuValida=?, dtValidacion=? where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ? ";
