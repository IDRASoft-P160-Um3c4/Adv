 ...
 * @version 1.0
 */
public class TDGRLObservacion5 extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      Vector vcdData = findByCustom(""," select * from CVHRepEquipoSeg  where "+
      ...
      TDCVHRepEquipoSeg dCVHDatosCalifica = new TDCVHRepEquipoSeg();
