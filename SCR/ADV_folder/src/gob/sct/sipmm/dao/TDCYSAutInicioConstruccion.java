...
/**
 * <p>Title: TDCYSAutInicioConstruccion.java</p>
 * <p>Description: DAO de la entidad CYSAutInicioConstruccion</p>
 * <p>Copyright: Copyright (c) 2005 </p>
 * <p>Company: Tecnología InRed S.A. de C.V. </p>
 * @author mbeano
 * @version 1.0
 */
public class TDCYSAutInicioConstruccion extends DAOBase{
  private TParametro VParametros = new TParametro("44");
  private String dataSourceName = VParametros.getPropEspecifica("ConDBModulo");
  private static final int iTITULO_DE_AUTORIZACION = 3; // RAC
  private static final int iINICIO_DE_CONSTRUCCION = 15; // RAC
  /**
   ...
   * <p><b> insert into CYSAutInicioConstruccion(iEjercicio,iMovEdoFinanciero,dtRegistro,dtPresentacion,dtPublicacion,iCveTitulo,cObsEdoFinanciero) values (?,?,?,?,?,?,?) </b></p>
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "insert into CYSAutInicioConstruccion(iCveTitulo, " +
                    "iMovAutIC, " +
                    "dtRegistro, " +
                    "dtPresentacion, " +
                    "cObsAutorizacion, " +
      ...
      //AGREGAR AL ULTIMO ...
      Vector vcData = findByCustom("","select MAX(iMovAutIC) AS iMovAutIC " +
                                      "from CYSAutInicioConstruccion  " +
                                      "where iCveTitulo = " + vData.getInt("iCveTitulo"));
      if(vcData.size() > 0){
         TVDinRep vUltimo = (TVDinRep) vcData.get(0);
         vData.put("iMovAutIC",vUltimo.getInt("iMovAutIC") + 1);
      }else
         vData.put("iMovAutIC",1);

      vData.addPK(vData.getString("iCveTitulo"));
      vData.addPK(vData.getString("iMovAutIC"));
      //...

      lPStmt = conn.prepareStatement(lSQL);
      lPStmt.setInt(1,vData.getInt("iCveTitulo"));
      lPStmt.setInt(2,vData.getInt("iMovAutIC"));
      ...
      lPStmt.setInt(6,vData.getInt("iCveTituloAutIC"));
   ...
   * <p><b> delete from CYSAutInicioConstruccion where iEjercicio = ? AND iMovEdoFinanciero = ?  </b></p>
   * <p><b> Campos Llave: iEjercicio,iMovEdoFinanciero, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public boolean delete(TVDinRep vData,Connection cnNested)throws
    ...
    try{
      ...
      String lSQL = "delete from CYSAutInicioConstruccion where iCveTitulo = ? AND iMovAutIC = ?  ";
      //...
   ...
   * <p><b> update CYSAutInicioConstruccion set dtRegistro=?, dtPresentacion=?, dtPublicacion=?, iCveTitulo=?, cObsEdoFinanciero=? where iEjercicio = ? AND iMovEdoFinanciero = ?  </b></p>
   * <p><b> Campos Llave: iEjercicio,iMovEdoFinanciero, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update CYSAutInicioConstruccion set dtRegistro=?, " +
                    "dtPresentacion=?, " +
                    "cObsAutorizacion=?, " +
                    "iCveTituloAutIC=? " +
                    "where iCveTitulo=? " +
      ...
      lPStmt.setInt(4,vData.getInt("iCveTituloAutIC"));
      lPStmt.setInt(5,vData.getInt("iCveTitulo"));
      lPStmt.setInt(6,vData.getInt("iMovAutIC"));
      lPStmt.executeUpdate();
      if(cnNested == null){
        conn.commit();
      }
 ...
 public Vector findBySitObligacion(String cKey, int iTitulo, java.sql.Date dtFecha) throws DAOException{
   Vector vcSitObligacion = new Vector();
     ...
     String cSQL = "select cysaic.iCveTitulo, " +
                   "       cysaic.iMovAutIC, " +
                   "       cysaic.dtRegistro, " +
                   "       cysaic.dtPresentacion, " +
                   "       cysaic.cObsAutorizacion, " +
                   "       cysaic.iCveTituloAutIC, " +
                   "       cpat.iCveTitulo, " +
                   "       cpat.iCveTipoTitulo, " +
                   "       cpat.cNumTitulo, " +
                   ...
                   "       cpat.lSustituido, " +
                   "       cpat.lArchivado " +
                   " from CYSAutInicioConstruccion cysaic " +
                   " inner join CPATitulo cpat on cysaic.iCveTituloAutIC = cpat.iCveTitulo " +
                   " where cysaic.iCveTitulo = " + iTitulo +
                   " and cysaic.iMovAutIC = (select max(iMovAutIC) from CYSAutInicioConstruccion where iCveTitulo = " + iTitulo + ")";
    ...
    if (vcRecords.size() > 0) {
      ...
      if (vDinRep.getInt("iCveTipoTitulo") == iTITULO_DE_AUTORIZACION &&
          vDinRep.getInt("iCveClasificacion") == iINICIO_DE_CONSTRUCCION) {
