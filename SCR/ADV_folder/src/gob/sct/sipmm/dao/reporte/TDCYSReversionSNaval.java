...
public class TDCYSReversionSNaval extends DAOBase{
  ...
  public TDCYSReversionSNaval(){
  }


  //public Vector genReversionPFP(String cQuery,String cNumFolio,String cCveOficinaOrigen,String cCveDeptoOrigen){
    public Vector genReversionSNaval(String cQuery,String cNumFolio,String cCveOficinaOrigen,String cCveDeptoOrigen){
      ...
      if (vRegs.size() > 0){
        ...
        if(vNotifRec.size()>0){
          ...
          if(vDinNotifRec.getDate("dtAsignacion")!=null)
