...
public class TDTEAFolio extends DAOBase{
	...
	DAOException{
		...
		try{
			...
			String lSQL =
				"insert into TEAFolio(iCveTermAnticipada,iConsecutivo,iEjercicio,iCveOficina,iCveDepartamento," +
				"cDigitosFolio,iConsecutivoFolio,iCveTipoDocto) values (?,?,?,?,?,?,?,?)";
			String cSQLMax = "select MAX(iConsecutivo) AS iConsecutivo from TEAFolio where iCveTermAnticipada = " + vData.getInt("iCveTermAnticipada");
//			AGREGAR AL ULTIMO ...
			...
			lPStmt.setInt(1,vData.getInt("iCveTermAnticipada"));
