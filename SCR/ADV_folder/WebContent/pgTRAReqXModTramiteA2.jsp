...
<%
/**
 * <p>Title: pgTRAReqXModTramiteA2.jsp</p>
 ...
 */
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    vDinRep = oAccion.setInputs("iOrden,lRequerido");
    try{
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  String cSql="Select iCveTramite,iCveModalidad,r.iCveRequisito,iOrden,lRequerido,cDscRequisito,cDscBreve,cFundLegal,lDigitaliza "+
              " from  TraReqXModTramite rxm  "+
              " join TRARequisito r  on rxm.iCveRequisito=r.iCveRequisito ";


  Vector vcListado = dTRAReqXModTramite.findByCustom("iCveTramite,iCveModalidad,iCveRequisito",cSql + oAccion.getCFiltro() + oAccion.getCOrden());
