 ...
 */
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    vDinRep = oAccion.setInputs("iCveRequisito,cDscCaracteristica,cDscBreve,lVigente,lEnRecepcion,lEnProceso,lMandatorio");
    try{
 ...
 try{
   vcListado = dTRACaracXRequisito.findByCustom("iCveRequisito,iCveCaracteristica"," Select TRACaracXRequisito.iCveRequisito,iCveCaracteristica,cDscCaracteristica,TRACaracXRequisito.cDscBreve,TRACaracXRequisito.lVigente,lEnRecepcion,lEnProceso,lMandatorio,TRARequisito.cDscBreve As Requisito "+
                                                                                   " from TRACaracXRequisito " +
                                                                                   " Join TRARequisito ON TRARequisito.iCveRequisito = TRACaracXRequisito.iCveRequisito " + oAccion.getCFiltro() + oAccion.getCOrden());
 }catch(Exception e){
   cError = e.getMessage();
 }
