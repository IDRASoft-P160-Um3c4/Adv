 ...
 */
 ...
 StringBuffer cSQL = new StringBuffer("");
		...
		cSQL.append("JOIN GRLENTIDADFED ESTADOSOL ON DOMPER.ICVEPAIS = ESTADOSOL.ICVEPAIS and DomPer.iCveEntidadFed = ESTADOSOL.ICVEENTIDADFED ");
		cSQL.append("JOIN GRLMUNICIPIO MUNSOL ON DOMPER.ICVEPAIS = MUNSOL.ICVEPAIS and DomPer.iCveEntidadFed = MUNSOL.ICVEENTIDADFED ");
		...
		cSQL.append("JOIN GRLENTIDADFED ESTADOREP ON DOMREP.ICVEPAIS = ESTADOREP.ICVEPAIS and DomREP.iCveEntidadFed = ESTADOREP.ICVEENTIDADFED ");
		cSQL.append("JOIN GRLMUNICIPIO MUNREP ON DOMREP.ICVEPAIS = MUNREP.ICVEPAIS and DomREP.iCveEntidadFed = MUNREP.ICVEENTIDADFED ");
...
//		cSQL.append("AND TRAREGSOLICITUD.INUMSOLICITUD = trexmt.INUMSOLICITUD AND trexmt.ICVEETAPA = 1 ");
		...
		cSQL.append("JOIN SEGUsuario UR ON UR.iCveUsuario=TRARegSolicitud.iCveUsuRegistra ");
