 ...
 */
  ...
  int iCveEtapaVisita = Integer.parseInt(vParametros.getPropEspecifica("EtapaVisita"));
  int iCveEtapaResolucionVisita= Integer.parseInt(vParametros.getPropEspecifica("EtapaResolucionVisita"));
  int iCveEtapaEntregaPermiso = Integer.parseInt(vParametros.getPropEspecifica("EtapaEntregaPermiso"));
  ...
  String cEtapas = iCveEtapaConcluidoArea + "," + iCveEtapaVerificacion + "," + iCveEtapaEntregarVU + "," +
    ...
    vParametros.getPropEspecifica("EtapaTramiteCancelado") + "," + vParametros.getPropEspecifica("TramiteCertificacionDoc") + "," + iCveEtapaVisita +"," +iCveEtapaResolucionVisita+","+iCveEtapaEntregaPermiso;
