 ...
 */
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  ...
  try{
    vcListado = dGRLOficina.findByCustom("iCveOficina","Select iCveOficina,cDscOficina,cDscBreve,iCveCategoria,iCvePais,iCveEntidadFed,iCveMunicipio,cCalleYNo,cColonia,cCodPostal,cTitular,cTelefono,cCorreoE,lVigente from GRLOficina " + oAccion.getCFiltro() + oAccion.getCOrden());
  }catch(Exception ex){
