...
<%
/**
 * <p>Title: pgGRLObservacionA2.jsp</p>
 * <p>Description: JSP "Catálogo" de la entidad GRLObservacion</p>
 ...
 */
  ...
  TVDinRep vDinRep;
  TDGRLObservacionA2 dGRLObservacion = new TDGRLObservacionA2();
  String cError = "";
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    vDinRep = oAccion.setInputs("cObsRegistrada");
    try{
