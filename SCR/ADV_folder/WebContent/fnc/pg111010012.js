    ...
    ITRTD("",0,"","center","");
      InicioTabla("ETablaInfo",0,"0","","center","",1);
        ...
        FITR();
          ...
          TDEtiCampo(true,"EEtiqueta",0," Teléfono:","cTelefono","",25,50," Teléfono","fMayus(this);","","",false,"EEtiquetaL",1);
        FTR();
        ITRTD("EEtiqueta",0,"","","left","");
          //TextoSimple("País, Entidad,Municipio:");
        TextoSimple("Entidad | Municipio:");
        FITD("",7);
...
function fNavega(){
  ...
  //alert("FNAVEGA : lSubmiteBusca -- lEditando --> " +lSubmiteBusca +"--"+ lEditando);
...
function fValidaTodo(){
  ...
  var telCad = " "+frm.cTelefono.value;
...
function fSetClavePersona(iCvePersona, iCveDomicilio){
	//alert("setClavePersona-->"+iCvePersona+" ,"+ iCveDomicilio);
