 ...
 function fDefPag(){
   ...
   InicioTabla("ETablaInfo",0,"","","center","","1");
     ...
     FTDTR();
       ...
       TDEtiCampo(true,"EEtiqueta",0,"No. Solicitud:","iNumSolicitudFiltro","",8,8,"Núm. Solicitud","fMayus(this);","","blankFields();");
   ...
   InicioTabla("ETablaInfo",0,"75%","","center","",1);
           ...
           ITD("ECampo",5,"","","LEFT","LEFT");
           Text(false,"tFechaVisita","",70,70,"Fecha en la que se realiza la Visita Técnica","","","",false,false);
           FTDTR();
         FinTabla();   
   ...
   InicioTabla("",0,"100%","","","","1");
     ITRTD("",0,"","","top");
         InicioTabla("ETablaInfo",0,"100%","","","",0);
	           ...
	           FTDTR();
	               TDEtiSelect(true, "EEtiqueta", 3, "Resolución:", "lResolucion", "onChangeResol();");
	               ITD("ECampo",5,"","","LEFT","LEFT");
	               Liga("*Anexar Oficio de Minuta Técnica","fSubirMinutaVT();","");
	           FTDTR();
	           	TDEtiCampo(false,"EEtiqueta",2,"Representante Centro SCT:","cRepCSCT","",50,80,"Representante","fMayus(this);");
	           	TDEtiCampo(false,"EEtiqueta",4,"Cargo:","cCargoCSCT","",50,80,"Cargo","fMayus(this);");
	           FTDTR();
		    	TDEtiCampo(false,"EEtiqueta",2,"Representante Promovente:","cRepProm","",50,80,"Representante","fMayus(this);");
		    	TDEtiCampo(false,"EEtiqueta",4,"Cargo:","cCargoProm","",50,80,"Cargo","fMayus(this);");
		       FTDTR();
		    	TDEtiCampo(false,"EEtiqueta",2,"Representante Concesionario:","cRepConce","",50,80,"Representante","fMayus(this);");
		    	TDEtiCampo(false,"EEtiqueta",4,"Cargo:","cCargoConce","",50,80,"Cargo","fMayus(this);");
		       FTDTR();
		    	TDEtiAreaTexto(false,"EEtiqueta",1,"Comentario Centro SCT:",75,4,"cComentCSCT","","Comentario Centro SCT:","","fMayus(this);",'onchange="fMxTx(this,750);" onkeydown="fMxTx(this,750);" onblur="fMxTx(this,750);" ',true,true,true,"ECampo",4);
		    	TDEtiAreaTexto(false,"EEtiqueta",1,"Comentario Promovente:",75,4,"cComentProm","","Comentario Promovente:","","fMayus(this);",'onchange="fMxTx(this,750);" onkeydown="fMxTx(this,750);" onblur="fMxTx(this,750);"',true,true,true,"ECampo",3);
		       FTDTR();
		    	TDEtiAreaTexto(false,"EEtiqueta",1,"Comentario Concesionario:",75,4,"cComentConce","","Comentario Concesionario:","","fMayus(this);",'onchange="fMxTx(this,750);" onkeydown="fMxTx(this,750);" onblur="fMxTx(this,750);"',true,true,true,"ECampo",4);	
            	TDEtiAreaTexto(false,"EEtiqueta",1,"Observaciones:",75,4,"cObs","","Observaciones:","","fMayus(this);",'onchange="fMxTx(this,250);" onkeydown="fMxTx(this,250);" onblur="fMxTx(this,250);"',true,true,true,"ECampo",3);
...
//            	TDEtiAreaTexto(false,"EEtiqueta",1,"Acuerdos:",75,4,"cAcuerdo","","Acuerdos:","","fMayus(this);",'onkeydown="fMxTx(this,750);"',true,true,true,"ECampo",4);
		       ...
		       ITRTD("",10,"","","center");
		       	Liga("Agregar acuerdo/conclusión","agregarComentario();","Búsqueda de la Solicitud");
		       FTDTR();	
		       ITRTD("",10,"","","center");
 ...
 function fNavega(vModo){
   if (frm.iEjercicioFiltro.value != 0 && frm.iEjercicioFiltro.value != '' &&
	   ...
	   if(fSoloNumeros(frm.iEjercicioFiltro.value) && fSoloNumeros(frm.iNumSolicitudFiltro.value)){
	   				...
	   				frm.hdFiltro.value = " TRAREGSOLICITUD.IEJERCICIO="+ frm.iEjercicioFiltro.value + 
      				                     " AND TRAREGSOLICITUD.INUMSOLICITUD=" + frm.iNumSolicitudFiltro.value+
						   			     ...
						   			     " TRAREGRESOLVTECXSOL.IEJERCICIO="+frm.iEjercicioFiltro.value+
						   			     " AND TRAREGRESOLVTECXSOL.INUMSOLICITUD="+ frm.iNumSolicitudFiltro.value +")" +
	   				                     " and TRAREGETAPASXMODTRAM.iCveOficina = " + frm.iCveOfic.value +
	   				                     " AND TRAREGETAPASXMODTRAM.iCveDepartamento = " + frm.iCveDpto.value; 
...
//	   }
 ...
 function fNuevo(){
	 ...
	 if(frm.cSolicitante.value!="" && frm.cHomoclave.value!="" && frm.cDscTramite.value!="" && frm.cDscModalidad.value!="" && frm.tFechaVisita.value!=""){
 ...
 function fGuardar(){
	 ...
	 if(frm.lResolucion.value==-1){
		 ...
		 if(confirm("\n ¿Desea guardar una resolución "+txRes+" a la visita técnica?")){
...
function fSubirMinutaVT(){
	...
	permiteSubir=true;	
	   ...
	   if (frm.iEjercicioFiltro.value != 0 && frm.iEjercicioFiltro.value != '' &&
		       frm.iNumSolicitudFiltro.value != 0 && frm.iNumSolicitudFiltro.value != ''){
			   if(fSoloNumeros(frm.iEjercicioFiltro.value) && fSoloNumeros(frm.iNumSolicitudFiltro.value)&&(permiteSubir==true||negativa==true)){
				   fAbreSubWindow(false,"pgSubirMinutaVT","no","yes","yes","yes","800","600",50,50);
			   }
			   else
				   fAlert("\n Debe proporcionar un Ejercicio y Número de Solicitud válidos.");
	   }else{
...
function agregarComentario(){
	if(puedeAgregarAcuerdo==true){	
		...
		tCell.align = "center";
	    tCell.innerHTML =TDEtiAreaTextoID(prefijoAcuerdo+indiceAcuerdos,false,"EEtiqueta",1,"Acuerdo/Conclusión:",75,4,"","","Acuerdo/Conclusión:","","fMayus(this);",'onchange="fMxTx(this,750);" onkeydown="fMxTx(this,750);" onblur="fMxTx(this,750);"',true,true,true,"ECampo",3);
	    indiceAcuerdos++;
	}   
}
