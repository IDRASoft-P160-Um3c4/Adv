     ...
     InicioTabla("",0,"100%","","center");
       ...
       ITRTD("",0,"","1","center");
         InicioTabla("ETablaInfo",0,"95%","","","",1);
           ...
           TDEtiCampo(false,"EEtiqueta",0,"Unidad Administrativa:","cModulo","",73,73,"cModulo","fMayus(this);","","",false,"ECampo",5);
           FITR();
...
//       FTDTR();
 ...
 function fOnLoad(){
   ...
   FRMListado.fSetTitulo("Unidad Administrativa,Nombre del Reporte,");
...
//   FRMFiltro.fSetOrdena("Modulo,GRLReporte.iCveModulo,");
   FRMFiltro.fSetFiltra("Unidad Administrativa,GRLReporte.iCveModulo,");
   FRMFiltro.fSetOrdena("Unidad Administrativa,GRLReporte.iCveModulo,");
...
//    fFillSelect(frm.iCveOficina,aRes,false,frm.iCveOficina.value);
   ...
   if(cId == "IDDepto" && cError == ""){
    //fFillSelect(frm.iCveDepartamento,aRes,false,frm.iCveDepartamento.value,1,3);
	   frm.iCveDepartamento.value=aRes[0][0];
    fTraeDigitosFolio();
   }
  ...
  /*   else{
         fAlert("El Departamento que seleccionó no tiene asignado el pref  ijo del folio");
   ...
   if(cId == "cIdFirmantes" && cError == ""){
     //fFillSelect(frm.iCveFirmante,aRes,false,frm.iCveFirmante.value,2,5);
   }
...
//      frm.lAutoImprimirBOX.checked=false;
    ...
    if ( parseInt(frm.lParametroModificable.value,10) ==1 ){
      ...
      fDisabled(true,"iNumCopias,cNomDestino,");
    }
    else
      fDisabled(true);
 ...
 function fValidaRequiereFolio(){
   if ( parseInt(frm.lRequiereFolio.value,10 ) == 1 ){
     ...
     if(frm.cDigitosFolio.value == ''){
       fAlert("El Departamento que seleccionó no tiene asignado el prefijooo del folio");
       fSelectSetIndexFromValue(frm.iCveDepartamento, -1);
       return false;
     }
   }
