          ...
          ITR();
           ...
           FITR();
              //TDEtiSelect(true,"EEtiqueta",0,"Categoría:","iCveCategoria","","","","","EEtiquetaL","7");
           		Hidden("iCveCategoria",0);
           FITR();
//             TDEtiSelect(true,"EEtiqueta",0,"País:","iCvePais","fPaisOnChange();fEstadoOnChange();");
           Hidden("iCvePais",1); //valor uno para que sea por defecto Mexico, se solicito quitar este campo
           //FITR();
           ...
           FITR();
              ...
              //TDEtiCampo(true,"EEtiqueta",0,"Oficina CIS:","iCveOficinaCIS","",10,10,"Área CIS...","","","","","","");
           		Hidden("iCveOficIngresos",0);
           		Hidden("iCveUnidadMVA",0);
           		Hidden("iCveOficinaCIS",0);
...
//  FRMListado.fSetCampos("0,2,14,15,16,17,13,");
  FRMListado.fSetTitulo("Consecutivo,Desc. Breve,Estado,Municipio,Vigente,");
  FRMListado.fSetAlinea("center,left,left,left,center,");
  FRMListado.fSetDespliega("texto,texto,texto,texto,logico,");
  FRMListado.fSetCampos("0,2,16,17,13,");
...
function fBlankFields(){
	frm.iCveOficina.value="";
	frm.cDscOficina.value="";
	frm.cDscBreve.value="";
	frm.cColonia.value="";
	frm.cCalleYNo.value="";
    ...
    fDisabled(false,"iCveOficina,");
    FRMListado.fSetDisabled(true);
	fAsignaSelect(frm.iCveEntidadFed,0,"(DESCONOCIDO)");
	fEstadoOnChange();
	fGetEntidades();
}
