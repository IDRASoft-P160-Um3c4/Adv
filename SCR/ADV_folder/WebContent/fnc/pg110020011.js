...
function fOnLoad(){
  ...
  //FRMListado.fSetTitulo("Consecutivo,Proceso,Descripción de Trámite,Vigente,Proceso Certificado,Referencia o Código,");  //SE MODIFICA EL LISTADO EN ESTA PANTALLA
  ...
  FRMListado.fSetTitulo("Consecutivo,Proceso,Descripción de Trámite,");
  FRMListado.fSetAlinea("center,center,center,");
  FRMListado.fSetDespliega("texto,texto,texto,");
  FRMListado.fSetCampos("0,1,7,");
...
//if(frm.lProcesoCertificadoBOX.checked)  //COMENTADO PARA QUE NO SE MUESTREN LOS CAMPOS (VIGENTE, PROCESO CERTIFICADO, CODIGO)
