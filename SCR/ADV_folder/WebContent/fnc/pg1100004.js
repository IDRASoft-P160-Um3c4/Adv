...
function fDefPag(){
   ...
   InicioTabla("",0,"100%","45","white","tituloNew03.gif",".1",".1");
      ITRTD("",0,"1","","left");
      BtnImgJPG("BtnAcerca","sgadv_plecaA","fAcerca();","SGADV");
//      ImgNom("ImgLogo","Sipymm_plecaA.gif","");
//      BtnImg("BtnAcerca","Sipymm_plecaA");
...
function fOnLoad(){ // Carga informacion al mostrar la pogina.
...
function fAyuda(){
  ...
  cAyuda=cAyuda.substring(0,cAyuda.length-3)+cExtensionAyuda;
...
function BtnImgJPG(cNombreM,cNomImgM,cHRefM,cEstatusM,l4Status,cImgIni){ // 3000-boton de tipo imagen
   iImgs++;
