// MetaCD=1.0
 ...
 // Recepción de Resoluciones de Trámites de Ventanilla Unica
 // Author: iCaballero
 ...
 function fDefPag(){
   ...
   InicioTabla("",0,"100%","","","","1");
     ...
     InicioTabla("",0,"100%","","center");
       ...
       ITRTD("",0,"","10","center","top");
         InicioTabla("ETablaInfo",0,"75%","","","",1);         
           TDEtiCampo(true, "EEtiqueta", 0, "Ejercicio:", "iEjercicioF", "", 4, 4, "Ejercicio del Filtro...", "fMayus(this);", "");
         FinTabla();
       FTDTR();
       ...
       Hidden("lAnexo","");
       Hidden("hdEtapa","EtapaEntregarVU");
       Hidden("hdEtapaGuardar","EtapaRecibeResolucion");
       FinTabla();
     FTDTR();
 ...
 function fNavega(){
   if(parseInt(frm.iEjercicioF.value,10)>0){
	   frm.hdFiltro.value =  " TRARegsolicitud.iEjercicio = "+frm.iEjercicioF.value;
	   frm.hdOrden.value =  "iEjercicio,iNumSolicitud";
	   frm.hdNumReg.value =  1000;
	   return fEngSubmite("pgTRARecepcion.jsp","Listado");
   }
   else {
	   fAlert("Debe proporcionar un ejercicio de solicitud valido.");
	   return false;
   }
