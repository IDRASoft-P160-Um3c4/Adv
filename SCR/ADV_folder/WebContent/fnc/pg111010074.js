// MetaCD=1.0
 ...
 // Description: JS "Catálogo" de la entidad TRAGrupoConcepto
     ...
     InicioTabla("",0,"100%","","center");
       ...
       ITRTD("",0,"","1","center");
         InicioTabla("ETablaInfo",0,"75%","","","",1);
           ...
           FITR();
              TDEtiAreaTexto(true,"EEtiqueta",0,"Descripción:",75,3,"cDscGrupo","","Descripción","","fMayus(this);",'onkeydown="fMxTx(this,150);"',false,false,true,"",4);
           FITR();
              TDEtiCheckBox("EEtiqueta",0,"¿Aplica factor directo a este grupo?:","lAplicaFactorDirectoBOX","1",true,"En cálculo de tarifas a conceptos de este grupo se multiplicará las unidades por el factor del concepto.");
