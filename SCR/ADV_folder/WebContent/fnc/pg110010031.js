     ...
     InicioTabla("ETablaInfo",0,"95%","","","",1);
          ...
          ITR();
           ...
           FITR();
              ...
              ITD();Liga("Sincronizar usuarios","fSincronizaUsr();","Sincronizar usuarios");FTD();
           FITR();
     FinTabla();
   FinTabla();
...
//           TDEtiCheckBox("EEtiqueta",0,"¿Es Firmante?:","lFirmanteBOX","1",true,"Firmante de la oficina")
 ...
 function fResultado(aRes,cId,cError,cNavStatus,iRowPag,cLlave){
   ...
   if(cId == "cIdSincroniza" && cError == ""){
	   if(confirm("\nSe han actualizado los usuarios correctamente. ¿Desea recargar el listado?")){
		   fNavega();
	   }  
	}
...
function fSincronizaUsr(){
	frm.hdBoton.value = "sincronizaUsuariosADV";
	frm.hdFiltro.value = "";
    frm.hdOrden.value =  "Usuario";
    frm.hdNumReg.value =  10000;
    fEngSubmite("pgSEGUsuario.jsp","cIdSincroniza");
}