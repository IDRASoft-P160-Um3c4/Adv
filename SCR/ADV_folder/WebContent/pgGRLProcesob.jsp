...
<%
/**
 * <p>Title: pgGRLProcesob.jsp</p>
 * <p>Description: JSP "Catálogo" de la entidad GRLProceso</p>
 ...
 */
 ...
 /** Verifica si la Acción a través de hdBotón es igual a "Borrar" (Ya sea físico o lógico) */
  ...
  String cSQL = "Select " +
		"  GRLProceso.iCveProceso, " +
		"  GRLProceso.cDscProceso, " +
		"  GRLProceso.iCveTramite, " +
		"  GRLProceso.lVigente, " +
		"  GRLProceso.lProcesoCertificado, " +
		"  GRLProceso.cDscCertificacion, " +
		"  GRLProceso.iCveModalidad, " +
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  ...
  Vector vcListado = dGRLProceso.findByCustom("iCveProceso,iCveTramite,iCveModalidad",cSQL+
