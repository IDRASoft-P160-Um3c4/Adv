...
<%
/**
 * <p>Title: pgTRACatTramite1A.jsp</p>
 ...
 */
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    vDinRep = oAccion.setInputs("cCveInterna,cDscTramite,cDscBreve,lReqFirmaDigital,lVigente,cBienBuscar,cObjTramite,cComprobante,cNotas,lImprimeManual,iCveModulo");
    try{
 ...
 /** Verifica si la Acción a través de hdBotón es igual a "GuardarA" (Actualizar) */
  if(oAccion.getCAccion().equals("GuardarA")){
    vDinRep = oAccion.setInputs("iCveTramite,cCveInterna,cDscTramite,cDscBreve,lReqFirmaDigital,lVigente,cBienBuscar,cObjTramite,cComprobante,cNotas,lImprimeManual,iCveModulo");
    try{
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  ...
  if (oAccion.getCAccion().equals("GetTramites")){
    try{
      vcListado = dTRACatTramite.findByCustom("iCveTramite","SELECT iCveTramite, cCveInterna, cDscTramite, cDscBreve, lReqFirmaDigital, lVigente, cCveInterna || ' - ' || cDscBreve AS cCveDesc,cBienBuscar FROM TRACatTramite WHERE lVigente = 1 ");
      if (vcListado != null)
