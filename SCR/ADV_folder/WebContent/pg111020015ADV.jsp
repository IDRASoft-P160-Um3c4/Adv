 ...
 String strQuery = "";
  ...
  if(oAccion.getCAccion().equals("Historico")){
	  ...
	  strQuery = "SELECT " +
		         ...
		         " 		 (DAYS(current_date) - DAYS(date(TRAREGSOLICITUD.tsregistro))) AS DIASTRANS, "+//26
		        ...
		        "		 'SEN' AS SEN, "+//33
				 ...
				 " CASE WHEN FOL.DTPERMISO IS NOT NULL THEN (DAYS(FOL.DTPERMISO) - DAYS(date(TRAREGSOLICITUD.tsregistro))) ELSE -1 END AS DIASPERM, "+//44"+
		         " CASE WHEN TRAREGTRAMXSOL.DTCANCELACION IS NOT NULL THEN (DAYS(TRAREGTRAMXSOL.DTCANCELACION) - DAYS(DATE(TRAREGSOLICITUD.TSREGISTRO))) ELSE -1 END AS DIASCANCELA, "+ //45
		         " CASE WHEN TRAREGSOLICITUD.DTRESOLTRAM IS NOT NULL THEN (DAYS(TRAREGSOLICITUD.DTRESOLTRAM) - DAYS(DATE(TRAREGSOLICITUD.TSREGISTRO))) ELSE -1 END AS DIASRESOL, "+ //46
