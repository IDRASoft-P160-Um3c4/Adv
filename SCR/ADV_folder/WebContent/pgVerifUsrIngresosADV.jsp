 ...
 */
  ...
  try{
	  if(vcListado.size()>0){
		  ...
		  System.out.println("->->->->->-> "+vUsuario.getCPassword());
		  
		  String cSQLIng = "SELECT ICVEUSUARIO FROM SEGUSUARIO WHERE CUSUARIO = '"+ vUsuario.getCUsuario() +"' AND CPASSWORD='"+ vUsuario.getCPassword()+"'";
