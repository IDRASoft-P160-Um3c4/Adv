 ...
 */
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    vDinRep = oAccion.setInputs("iCvePersona,iCveDomicilio,iCveTipoDomicilio,cCalle,cNumExterior,cNumInterior,cColonia,cCodPostal,cTelefono,iCvePais,iCveEntidadFed,iCveMunicipio,iCveLocalidad");
    try{
 ...
 String cSql ="Select iCvePersona,iCveDomicilio,iCveTipoDomicilio,cCalle,cNumExterior,cNumInterior,cColonia,cCodPostal,cTelefono,GRLPAIS.CNOMBRE,GRLENTIDADFED.CNOMBRE,GRLMUNICIPIO.CNOMBRE " +//iCveLocalidad " +
              "from GRLDomicilio " +
