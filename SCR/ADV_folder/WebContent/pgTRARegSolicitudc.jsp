...
<%
/**
 * <p>Title: pgTRARegSolicitudc.jsp</p>
 ...
 */
  ...
  String cEtapasRestringidas = vParametros.getPropEspecifica("EtapaEntregarVU") + "," +
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  ...
  try{
    vcListado = dTRARegSolicitud.findByCustom("iEjercicio,iNumSolicitud","Select "+
  " GRLPersona.cNomRazonSocial as cNOm, GRLPersona.cAPPaterno as cAPp,GRLPersona.cAPMaterno as cAPM,GRLPersona.cRFC as cRFC, TRACatTramite.cDscBreve as cDscBreve, TRAModalidad.cDscModalidad as cMod "+
  ...
  //System.out.print("Tamaño vector = " + vcListado.size());
  oAccion.setINumReg(vcListado.size());
  oAccion.navega(vcListado);
  String cNavStatus = oAccion.getCNavStatus();
  //System.out.print("lisatdo "+vcListado.size());
%>
<SCRIPT LANGUAGE="JavaScript" SRC="<%=vParametros.getPropEspecifica("RutaFuncs")%>CD/ineng.js"></SCRIPT>
<script language="JavaScript">
<%
   out.print(oAccion.getArrayCD());
//   out.print(request.getParameter("cNombreFRM"));
%>
