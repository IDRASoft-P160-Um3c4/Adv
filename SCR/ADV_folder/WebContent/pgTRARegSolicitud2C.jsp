 ...
 */
 ...
 StringBuffer cSQL = new StringBuffer("");
		...
		cSQL.append("LEFT JOIN GRLPERSONA PerRepLegal ON TRARegSolicitud.icvereplegal = PerRepLegal.ICVEPERSONA ");
		cSQL.append("LEFT JOIN GRLDomicilio DomRep ON TRARegSolicitud.icvereplegal = DomRep.ICVEPERSONA ");
