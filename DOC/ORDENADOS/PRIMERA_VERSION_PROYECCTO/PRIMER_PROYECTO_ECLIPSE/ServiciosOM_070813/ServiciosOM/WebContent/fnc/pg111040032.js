// MetaCD=1.0
     ...
     InicioTabla("",0,"100%","","center");      //2
       ...
       ITRTD("",0,"","1","center");
         InicioTabla("ETablaInfo",0,"80%","","","",1);//3
           ...
           FITR();
              TDEtiCampo(false,"EEtiqueta",0," Modalidad :","cModalidad","",20,20," Modalidad ","fMayus(this);","","","", "EEtiquetaL", "2");
           FTR();
         FinTabla();                                           //1
         InicioTabla("ETablaInfo",0,"80%","","","",1);   //4
           ...
           ITR();
              TDEtiCampo(false,"EEtiqueta",2," Fecga y Hora de Recepción:","cHoraRecepcion","",20,20," RFC ","fMayus(this);", "", "", "","EEtiquetaL","0");
         ...
         InicioTabla("ETablaInfo",0,"80%","","","",1);      //5
           ...
           ITR();
              TDEtiCampo(false,"EEtiqueta",2," Solicitante:","cSolicitante","",50,50," RFC ","fMayus(this);");
 ...
 function fNavega(){
   ...
   fEngSubmite("pgTRARegSolicitud2A.jsp","DatosGenerales");
 }
