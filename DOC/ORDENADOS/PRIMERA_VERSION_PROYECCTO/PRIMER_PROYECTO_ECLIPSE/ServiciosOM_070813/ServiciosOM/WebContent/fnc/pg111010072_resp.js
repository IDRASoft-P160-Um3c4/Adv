// MetaCD=1.0
   ...
   InicioTabla("",0,"100%","","","","1");
     ITRTD("",0,"","","top");
       ITRTD("",0,"","0","center","top");
              ...
              //TDEtiSelect(true,"EEtiqueta",0,"Categoria:","iCveCategoria","fNavega1();");
           FITR();
     InicioTabla("",0,"100%","","center");
         ITRTD("",0,"","","center","");

             IFrame("IListado72B","95%","100","Listado.js","yes",true);
      //
      //   FinTabla();
         ITD("",0,"","","center","center");
     FinTabla();
        ...
        FTDTR();
           ...
           FITR();
           ITRTD("",0,"","","center","");
              IFrame("IListado72A","95%","120","Listado.js","yes",true);
         FinTabla();
         InicioTabla("",0,"100%","","center");
            TDEtiAreaTexto(true,"EEtiqueta",0,"Concepto:",100,2,"cDsc1","","Concepto","","fMayus(this);",'onkeydown="fMxTx(this,3);"');
         FinTabla();
     InicioTabla("",0,"100%","","center");
       FTDTR();
       ITRTD("",0,"","","center","top");
         ITRTD("",0,"","","center","");
           ...
           InicioTabla("",0,"95%","","center");
              ITD("",0,"","","center","");
                  IFrame("IListado72","100%","70","Listado.js","yes",true);
              FITR();
 ...
 function fOnLoad(){
  ...
  FRMListado.fSetSelReg(1);
   ...
   FRMListadoA.fSetTitulo("Fecha,Ref.Numerica,Concepto,Importe sin Ajuste, Importe con Ajuste,Tarifa,Porcentaje,");
   FRMListadoA.fSetDespliega("texto,texto,texto,texto,texto,logico,logico,");
   FRMListadoA.fSetAlinea("left,left,left,left,left,center,center,");
   FRMListadoA.fSetCampos("0,2,5,4,3,7,6,");
...
function fSelReg2(aDato){
   ...
   frm.lEsTarifaIzq.value = aDato[7];
   frm.lEsPorcentajeIzq.value = aDato[6];
