...
function fDefPag(){
  ...
  InicioTabla("",0,"100%","","","","1");
    InicioTabla("",0,"100%","","","","1");
      TDEtiSelect(true,"EEtiqueta",0,"Modulo:","iCveModulo","fModuloOnChange();","");
    FinTabla();
...
function fOnLoad(){
  ...
  FRMPanel.fShow("Tra,");
  frm.hdFiltro.value = "iCveSistema = 44 AND lActivo=1";
  ...
  fDisabled(true, "cCveTramite,iCveTramite,iCveModalidad,iCveOficinaUsr,iCveDeptoUsr,cDscBien,dUnidCalculo,iCveModulo,");
...
function fResultado(aRes,cId,cError,cNavStatus,iRowPag,cLlave){
  ...
  if(cId == "CIDTramite" && cError==""){
    if(frm.iCveModulo.value>0){
      for(i=0;i<aRes.length;i++){
        if(aRes[i][10]==frm.iCveModulo.value)
        aResTramiteOriginal[aResTramiteOriginal.length] = fCopiaArreglo(aRes[i]);
      }
      aRes = fCopiaArregloBidim(aResTramiteOriginal);
    }
  }
  ...
  if(cId == "Listado" && cError==""){
    ...
    if(frm.cDscBien.value != "")
      fDisabled(true, "cCveTramite,iCveTramite,iCveModalidad,iCveOficinaUsr,iCveDeptoUsr,iCveModulo,");
    else
      fDisabled(true, "cCveTramite,iCveTramite,iCveModalidad,iCveOficinaUsr,iCveDeptoUsr,cDscBien,dUnidCalculo,iCveModulo,");
  }
