...
// MetaCD=1.0
       ...
       ITRTD("",0,"","1","center");
         ...
         FinTabla();
           ITRTD("",0,"","30","center","top");
             Liga("Reasignar Trámite","fRecibeSolicitud();","Reasignar Trámite a otro Departamento");
           FTDTR();
 ...
 function fOnLoad(){
   ...
   FRMListado.fSetTitulo("Reasignar,Anexos,Ejercicio,Núm. Solicitud,Trámite,Modalidad,");
...
function fRecibeSolicitud(){
 ...
 if(!confirm("¿Esta seguro que desea reasignar el trámite?")){
   return;
 }
