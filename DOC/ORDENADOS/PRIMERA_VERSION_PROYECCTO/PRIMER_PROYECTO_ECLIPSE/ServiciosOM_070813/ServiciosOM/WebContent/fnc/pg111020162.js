   ...
   InicioTabla("",0,"100%","","","","1");
     ...
     InicioTabla("",0,"100%","","center");
       ...
       InicioTabla("ETablaInfo",0,"95%","","","",1);
           ...
           TextoSimple("Dependencia, Trámite y Modalidad");
           FITR();
              TDEtiCampo(false,"EEtiqueta",0,"Dependencia:","cNomRazonSocial","",60,60,"Oficina","fMayus(this);");
           FITR();
              TDEtiCampo(false,"EEtiqueta",0,"Opinión Dirigido a:","cOpinionDirigidoA","",60,60,"Departamento","fMayus(this);");
...
//Se carga el select correspondiente al módulo
...
//Se reciben  valores de la página anterior.
