// MetaCD=1.0
         ...
         ITRTD("",0,"","","top");
           InicioTabla("",0,"","","center");
             ...
             if(window.parent.fGetFiltroA){
               ITR();
               TDEtiCampo(true,"EEtiqueta",0,window.parent.fGetDescFiltroA()+":",window.parent.fGetFiltroA(),"",10,30,"Filtro de busqueda de la solicitud","fMayus(this);"," onKeyPress='return fCheckForEnter(event, this, window);' ");
             }
             if(window.parent.fGetFiltroB){
               ITD();
               TDEtiCampo(true,"EEtiqueta",0,window.parent.fGetDescFiltroB()+":",window.parent.fGetFiltroA(),"",10,30,"Filtro de busqueda de la solicitud","fMayus(this);"," onKeyPress='return fCheckForEnter(event, this, window);' ");
             }
             if(window.parent.fGetFiltroC){
               FITD();
               TDEtiCampo(true,"EEtiqueta",0,window.parent.fGetDescFiltroC()+":",window.parent.fGetFiltroA(),"",10,30,"Filtro de busqueda de la solicitud","fMayus(this);"," onKeyPress='return fCheckForEnter(event, this, window);' ");
             }
             if(window.parent.fGetFiltroD){
               FITD();
               TDEtiCampo(true,"EEtiqueta",0,window.parent.fGetDescFiltroD()+":",window.parent.fGetFiltroA(),"",10,30,"Filtro de busqueda de la solicitud","fMayus(this);"," onKeyPress='return fCheckForEnter(event, this, window);' ");
             }
             FITD();
       ...
       InicioTabla("",0,"","","center");
         ITRTD("",0,"","","center");
           InicioTabla("ETablaInfo",0,"","","","",1);
             ...
             FTR();
             ITR();
               TDEtiCampo(true,"EEtiqueta",0," Ejercicio:","iEjercicio","",4,4," Ejercicio ","fMayus(this);"," onKeyPress='return fCheckForEnter(event, this, window);' ");
               TDEtiCampo(true,"EEtiqueta",0," Número de Solicitud:","iNumSolicitud","",5,5," Solicitud ","fMayus(this);"," onKeyPress='return fCheckForEnter(event, this, window);' ");
             ...
             FTR();
             ITR();
               TDEtiCampo(false,"EEtiqueta",0," Trámite:","cTramite","",80,60," Trámite ","fMayus(this);","","",false,"ECampo",5);
             FITR();
               TDEtiCampo(false,"EEtiqueta",0," Modalidad:","cModalidad","",80,60," Modalidad ","fMayus(this);","","",false,"ECampo",5);
             FITR();
               TDEtiCampo(false,"EEtiqueta",0," Aplica a:","cDscBien","",80,60," Descripción del Bien ","fMayus(this);","","",false,"ECampo",5);
             FTR();
           FinTabla();
         FTDTR();
       FinTabla();
   ...
   InicioTabla("",0,"","","center","","",0);
     ...
     InicioTabla("",0,"100%","","center");
         InicioTabla("ETablaInfo",0,"","","","",1);
           ...
           ITR();
              TDEtiCampo(false,"EEtiqueta",2," RFC:","CRFCSol","",15,15," RFC ","fMayus(this);");
           FITR();
              TDEtiCampo(false,"EEtiqueta",2," Correo Electrónico:","CElectSol","",30,30," Correo Electrónico ","fMayus(this);");
           FITR();
              TDEtiCampo(false,"EEtiqueta",2," Nombre o Razón Social:","CNomSol","",110,210," Nombre o Razón Social ","fMayus(this);","","","","EEtiquetaL","3");
           FITR();
              TDEtiCampo(false,"EEtiqueta",2," Dirección:","cDirSol","",110,210," Nombre o Razón Social ","fMayus(this);","","","","EEtiquetaL","3");
           FTR();

           ITRTD("ETablaST",5,"","","center");
             TextoSimple("DATOS DEL REPRESENTANTE LEGAL");
           FTDTR();
              TDEtiCampo(false,"EEtiqueta",2," RFC:","cRFCrl","",15,15," RFC ","fMayus(this);");
           FITR();
              TDEtiCampo(false,"EEtiqueta",2," Correo Electrónico:","CElectRL","",30,30," Correo Electrónico ","fMayus(this);");
           FITR();
              TDEtiCampo(false,"EEtiqueta",2," Nombre:","cNombrerl","",110,210," Nombre o Razón Social ","fMayus(this);","","","","EEtiquetaL","3");
           FITR();
              TDEtiCampo(false,"EEtiqueta",2," Dirección:","cDirRep","",110,210," dirección del Representante ","fMayus(this);","","","","EEtiquetaL","3");
           FITR();
              TDEtiCheckBox("EEtiqueta",3,"Cumple con los Requisitos de la Solicitud:","lCumpleBOX","1",true,"Cumple con los Requisitos","","","EEtiquetaL","3");
              Hidden("iCveProceso","");
           FITR();
              TDEtiCheckBox("EEtiqueta",3,"Cumple con la Evaluación Técnica:","lCumpleETBOX","1",true,"Cumple con los Requisitos");
              Hidden("iCveProceso","");
           ITD("",0,"","","left","");
        ...
        InicioTabla("ETablaInfo",0,"100%","","center");
          ...
          ITR("ETablaInfo",0,"","","center","");
            ITD("EEtiquetaC");
              Liga("[Evaluación Técnica]","fVerifica();","Verifica requisitos cualitativamente");
            FITD("",0,"","","center","");
              Liga("[Adjuntar Documentos]","fEjecutaDocumentos();","Adjunta Documentos a la Solicitud");
            FTD();  
          FITR();           
            ITD("",0,"","","center","");
              Liga("[Mostrar Solicitudes Relacionadas]","if(frm.iEjercicio.value!='' && frm.iNumSolicitud.value!='')fAbreSolicitudesRelacionadas();else fAlert('\n-Debe seleccionar ejercicio y solicitud para mostrar las relacionadas');","Muestra las solicitudes relacionadas y sus etapas");
            FITD("",0,"","","center","");
              Liga("[Consulta de Solicitudes]","if(frm.iEjercicio.value!='' && frm.iNumSolicitud.value!='' && frm.cTramite.value != '')fAbreConsSolicitud();else fAlert('\n-Debe seleccionar ejercicio y solicitud validos para consultar dicha solicitud');","Muestra las solicitudes relacionadas y sus etapas");
            FTD();
          FITR();  
            ITD();
              Liga("[Documentos Digitales Anexos al Trámite por Internet con FIEL]","fDocDig();","...");
            FITD();
            //Liga("[Importar Campos del Trámite por Internet con FIEL]","fImportaCampo();","...");
 ...
 function fResultado(aRes,cId,cError,cNavStatus,iRowPag,cLlave,cEtapasRestringidas){
   if(cError=="Guardar")
   ...
   if(cError == ""){
     ...
     if(cId == "Listado"){
       ...
       if (aDato[14] != "") frm.cDirSol.value = frm.cDirSol.value + " Int." + aDato[14];
       frm.cDirSol.value = frm.cDirSol.value + " Col. " + aDato[15] + ", " + aDato[17] +", " + aDato[16];
       frm.cDirRep.value = aDato[18] + " #" + aDato[19];
       if (aDato[20] != "") frm.cDirRep.value = frm.cDirRep.value + " Int." + aDato[20];
       frm.cDirRep.value = frm.cDirRep.value + " Col. " + aDato[21] + ", " + aDato[23] +", " + aDato[22];
       ...
       if (window.parent.fGetParms)
         window.parent.fGetParms(frm.iEjercicio.value, frm.iNumSolicitud.value, frm.cTramite.value,
                                 frm.cModalidad.value, frm.CRFCSol.value, frm.CNomSol.value,
                                 cFechaRegSol,frm.iCvePersona.value, frm.iCveDomicilio.value,frm.iCveRepLegal.value,
                                 frm.iCveTramite.value);
       fCancelar();
       frm.hdFiltro.value = "";
     /**Eliminar ELEL*/
       frm.hdFiltro.value =  " TRAREGREQXTRAM.IEJERCICIO = " + frm.iEjercicio.value + " AND TRAREGREQXTRAM.INUMSOLICITUD = " + frm.iNumSolicitud.value + " AND TRAREGREQXTRAM.DTRECEPCION IS NULL";
   ...
   if(cId == "IDUsrXOfic" && cError == ""){
     ...
     if(!fBuscaTramite(0)){
       ...
       for(y=0; y < aRes.length ; y++){
         frm.hdFiltroUsrXDepto.value += " (trexmt.iCveOficina = " + aRes[y][0] +
                              " AND trexmt.iCveDepartamento = " + aRes[y][1] + ") ";
         if (y < (aRes.length - 1) )
...
function fValidaCampos(){
  if (frm.iEjercicio.value != "" && frm.iNumSolicitud.value != ""){
    if (''+parseInt(frm.iEjercicio.value,10) != "NaN" && ''+parseInt(frm.iNumSolicitud.value,10) != "NaN")
      fTraeUsrXDeptos();
    else{
...
function fGetTsRegistroSoloFecha(){
  ...
  if(frm.tsRegistro.value=="")
   dtTsRegistro="";
    ...
    dtTsRegistro = frm.tsRegistro.value.substring(0,2) + " de " + mes + " de " + frm.tsRegistro.value.substring(6,10);
  }
  return dtTsRegistro;
}
...
function fRequisitos(){
  frm.hdSelect.value =
    "SELECT RS.ICVETRAMITE,RS.ICVEMODALIDAD,RRT.LVALIDO FROM TRAREGSOLICITUD RS " +
    ...
    "Where LVALIDO = 0 and RS.iEjercicio = "+frm.iEjercicio.value+" AND RS.iNumSolicitud = "+frm.iNumSolicitud.value;
  frm.hdLlave.value  = "";
...
function fBuscaPNC(){
  frm.hdSelect.value =
    "SELECT PNC.LRESUELTO, PNC.DTRESOLUCION FROM TRAREGPNCETAPA PNCE " +
    "JOIN GRLREGISTROPNC PNC ON PNC.IEJERCICIO = PNCE.IEJERCICIOPNC AND " +
    " PNC.ICONSECUTIVOPNC = PNCE.ICONSECUTIVOPNC " +
    "Where PNCE.iEjercicio = "+frm.iEjercicio.value+" AND PNCE.iNumSolicitud = " + frm.iNumSolicitud.value +
    " AND PNC.LRESUELTO = 0";
  frm.hdLlave.value  = "";
...
function fEvaluacion(){
  frm.hdSelect.value =
     "SELECT TS.ICVETRAMITE, TS.ICVEMODALIDAD, RRT.DTRECEPCION " +
     ...
     "Where RRT.DTRECEPCION is null and TS.iEjercicio = "+frm.iEjercicio.value+" AND TS.iNumSolicitud = "+frm.iNumSolicitud.value;
  frm.hdLlave.value  = "";
...
function fBuscaTramite(tramite){
  ...
  for(i=0;i<aTramites.length;i++){
    if(parseInt(aTramites[i],10) == parseInt(tramite,10)) return true;
  }
  return false;
}
