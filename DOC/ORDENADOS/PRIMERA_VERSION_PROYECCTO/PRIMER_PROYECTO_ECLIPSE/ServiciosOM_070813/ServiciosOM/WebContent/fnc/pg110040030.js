// MetaCD=1.0 
 ...
 // Description: JS "Catálogo" de la entidad GRLTipoDomicilio
     ...
     InicioTabla("",0,"100%","","center"); 
       ...
       ITRTD("",0,"","1","center"); 
         InicioTabla("ETablaInfo",0,"75%","","","",1); 
           ...
           FITR(); 
              TDEtiAreaTexto(true,"EEtiqueta",0," Descripción:",25,2,"cDscTipoDomicilio",""," Descripción","","fMayus(this);",'onkeydown="fMxTx(this,30);"'); 
           FTR(); 
         FinTabla(); 
       FTDTR(); 
       FinTabla(); 
 ...
 function fOnLoad(){ 
   ...
   FRMListado.fSetTitulo(" Clave, Descripción,"); 
  FRMListado.fSetAlinea("center,left,");
  FRMListado.fSetDespliega("texto,texto,");
   FRMFiltro = fBuscaFrame("IFiltro"); 
   FRMFiltro.fSetControl(self); 
   FRMFiltro.fShow(); 
   FRMFiltro.fSetFiltra(" Consecutivo,iCveTipoDomicilio, Descripción,cDscTipoDomicilio,"); 
   FRMFiltro.fSetOrdena(" Consecutivo,iCveTipoDomicilio, Descripción,cDscTipoDomicilio,"); 
   fDisabled(true); 
