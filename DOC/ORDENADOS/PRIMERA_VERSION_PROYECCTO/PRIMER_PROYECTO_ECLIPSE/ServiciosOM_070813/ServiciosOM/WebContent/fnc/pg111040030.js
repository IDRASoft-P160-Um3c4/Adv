  ...
  InicioTabla("",0,"100%","100%");
    ...
    ITRTD("",0,"100%","100%","center","middle");
       fDefCarpeta( "Listado de Solicitudes|Datos Generales|Requisitos y pagos|Etapas Registradas|" ,
                     "pg111040031.js|pg111040012.js|pg111040013.js|pg111040014.js|" ,
                     "PEM" , "99%" , "99%", true);
    FTDTR();
  FinTabla();
  fFinPagina();
...
function fOnLoad(){
   ...
   if(top.opener){
	   ...
	   iEjercicio=top.opener.fGetiEjercicio();
       }
       if(top.opener.fGetiNumSolicitud){
	   iNumSolicitud = top.opener.fGetiNumSolicitud();
       }
       if(iEjercicio>0 && iNumSolicitud>0){
	   ConSolicitudes = fBuscaFrame("PEM1");
	   ConSolicitudes.frm.iEjercicioFiltro.value = iEjercicio;
	   ConSolicitudes.frm.iNumSolicitudFiltro.value = iNumSolicitud;
	   //ConSolicitudes.fBuscar();
       }
   }
}
