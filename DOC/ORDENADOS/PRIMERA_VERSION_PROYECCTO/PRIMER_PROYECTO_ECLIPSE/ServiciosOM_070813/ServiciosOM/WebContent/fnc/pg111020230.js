// MetaCD=1.0
 // Title: pg111020230.js
 // Company: Tecnología InRed S.A. de C.V.
 // Recepción de Resoluciones de Trámites de Oficialía
 // Author: iCaballero
   ...
   InicioTabla("",0,"100%","","","","1");
     ...
     InicioTabla("",0,"100%","","center");
       ...
       ITRTD("",0,"","30","center","top");
         Liga("Recibir Documentos","fRecibeSolicitud();","Registrar como recibida la solicitud");
       FTDTR();
       if (top.fGetUsrID())
       ...
       Hidden("lAnexo","");
       Hidden("hdEtapa","EtapaEntregaResol");
       Hidden("hdEtapaGuardar","EtapaDocRetorno");
       Hidden("hdPropEspecifica1","DeptoVentanillaUnica");
       Hidden("hdPropEspecifica2","EtapaEntregarVU");
       FinTabla();
     FTDTR();
