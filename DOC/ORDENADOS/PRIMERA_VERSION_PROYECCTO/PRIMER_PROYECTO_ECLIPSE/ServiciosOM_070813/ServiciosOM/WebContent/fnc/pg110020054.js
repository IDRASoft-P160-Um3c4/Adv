        ...
        InicioTabla("",0,"","","left");
          ...
          ITRTD("",0,"","","","top");
            InicioTabla("",0,"","","center");
              ...
              FITR();
                TDEtiCampo(true,"EEtiqueta",0,"Señal Distintiva:","cSenalDist","",25,0,"ClaveEspecialidad","fMayus(this);");
              FITR();
          ...
          InicioTabla("",0,"","","top");
            ...
            InicioTabla("",1,"100%","100%","right");
              ...
              InicioTabla("",0,"","","center");
                ...
                FITR();
                  TDEtiCampo(true,"EEtiqueta",0,"Señal Distintiva:","cSenalDistO","",25,0,"ClaveEspecialidad","fMayus(this);");
                FITR();
...
function fOnLoad(){
  ...
  FRMListadoMatD.fSetTitulo("Matricula,Fecha Alta,Puerto,Navegación,Servicio,Propietario,");
  FRMListadoMatD.fSetCampos("20,7,8,9,10,11,");
  FRMListadoMatO = fBuscaFrame("IListadoMatO");
  FRMListadoMatO.fSetControl(self);
  FRMListadoMatO.fSetTitulo("Matricula,Fecha Alta,Puerto,Navegación,Servicio,Propietario,");
  ...
  IListadoRPMND.fSetTitulo("Folio,Sección,Tipo Acto,Fecha Alta,Fecha Baja,");
  ...
  IListadoRPMNO.fSetTitulo("Folio,Sección,Tipo Acto,Fecha Alta,Fecha Baja,");
  ...
  IListadoInspD.fSetTitulo("Inicio Inspección,Fin Inspección,Puerto,Observaciones,");
  ...
  IListadoInspO.fSetTitulo("Inicio Inspección,Fin Inspección,Puerto,Observaciones,");
 ...
 function fResultado(aRes,cId,cError,cNavStatus,iRowPag,cLlave){
   ...
   if(cId == "Listado" && cError==""){
     if(aRes.length>0){
       ...
       frm.cTipoEmbarcación.value = aRes[0][2];
...
function fIntegrarMotor(){
    if(confirm("¿Esta seguro de que desea integrar esté Motor?")){
...
function fIntegrarDocto(){
    if(confirm("¿Esta seguro de que desea integrar esté Documento?")){
...
function fIntegrarRPMN(){
  if(confirm("¿Esta seguro de que desea integrar esté Registro?")){
...
function fIntegrarArribo(){
  if(confirm("¿Esta seguro de que desea integrar esté Arribo / Despacho?")){
