...
function fDefPag(){
  ...
  InicioTabla("",0,"100%","100%");
    ...
    ITRTD("",0,"100%","100%","center","middle");
       fDefCarpeta( "Listado de Solicitudes|Datos Generales|Requisitos y pagos|Etapas|" ,
                     "pg111040041.js|pg111040012.js|pg111040013.js|pg111040014.js|" ,
                     "PEM" , "99%" , "99%", true);
    FTDTR();
  FinTabla();
  fFinPagina();
