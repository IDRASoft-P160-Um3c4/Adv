...
function fDefPag(){ // Define la página a ser mostrada
  ...
  InicioTabla("",0,"100%","100%");
    ...
    ITRTD("",0,"100%","100%","center","middle");
       fDefCarpeta("Solicitante y<br>Rep. Legal|Trámites y Requisitos|Solicitudes|",
                   "pg111020011.js|pg111020012.js|pg111020013.js|",
                   "PEM", "99%", "99%",true);
    FTDTR();
    Hidden("iCvePersona");
    Hidden("cRFC");
...
function validaCorreoElectronico(){
	if(frm.cCorreoE.value==""){
		alert("El correo electronico proporcionado para este solicitante no es valido favor de corregirlo en la pestaña anterior.");
		return false;
	}
	return true;
}