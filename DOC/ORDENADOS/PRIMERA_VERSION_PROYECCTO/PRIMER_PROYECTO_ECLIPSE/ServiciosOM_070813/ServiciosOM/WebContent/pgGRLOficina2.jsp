 ...
 */
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    vDinRep = oAccion.setInputs("cDscOficina,cDscBreve,iCveCategoria,iCvePais,iCveEntidadFed,iCveMunicipio,cCalleYNo,cColonia,cCodPostal,cTitular,cTelefono,cCorreoE,lVigente,iCveOficIngresos,iCveUnidadMVA");
    try{
 ...
 /** Verifica si la Acción a través de hdBotón es igual a "GuardarA" (Actualizar) */
  if(oAccion.getCAccion().equals("GuardarA")){
    vDinRep = oAccion.setInputs("iCveOficina,cDscOficina,cDscBreve,iCveCategoria,iCvePais,iCveEntidadFed,iCveMunicipio,cCalleYNo,cColonia,cCodPostal,cTitular,cTelefono,cCorreoE,lVigente,iCveOficIngresos,iCveUnidadMVA");
    try{
