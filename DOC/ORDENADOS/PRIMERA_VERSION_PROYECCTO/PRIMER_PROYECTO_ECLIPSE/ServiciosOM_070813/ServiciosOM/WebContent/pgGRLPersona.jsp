 ...
 */
 ...
 String cSQL =   " SELECT iCvePersona, cRFC, cRPA, iTipoPersona, cNomRazonSocial, cApPaterno, "+
		  " cApMaterno, cCorreoE, cPseudonimoEmp "+
		  " FROM GRLPersona ";
  Vector vcListado = dGRLPersona.findByCustom("iCvePersona",cSQL + oAccion.getCFiltro() + oAccion.getCOrden());
