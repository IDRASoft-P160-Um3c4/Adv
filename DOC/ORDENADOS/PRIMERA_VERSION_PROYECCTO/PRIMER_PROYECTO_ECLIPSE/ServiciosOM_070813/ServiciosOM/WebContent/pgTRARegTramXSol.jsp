 ...
 /** Verifica si la Acción a través de hdBotón es igual a "GuardarA" (Actualizar) */
  if(oAccion.getCAccion().equals("GuardarA")){
    ...
    try{
     ...
     regEtapasXModTram.upDateEstadoInformativoCIS(vDinRep.getInt("iEjercicio"),vDinRep.getInt("iNumSolicitud"),
    		                             Integer.parseInt(vParametros.getPropEspecifica("estadoCIS_Cancelado")),null);
