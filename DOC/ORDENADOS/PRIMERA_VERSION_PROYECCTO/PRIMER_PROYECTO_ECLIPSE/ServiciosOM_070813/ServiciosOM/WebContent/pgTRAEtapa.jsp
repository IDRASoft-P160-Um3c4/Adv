 ...
 */
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  Vector vcListado = dTRAEtapa.findByCustom("iCveEtapa","Select TRAEtapa.iCveEtapa,TRAEtapa.cDscEtapa,TRAEtapa.lVigente from TRAEtapa " + oAccion.getCFiltro() + oAccion.getCOrden());
