...
<%
/**
 * <p>Title: pgGRLTipoDocumentoC.jsp</p>
 ...
 */
  ...
  TVDinRep vDinRep;
  TDGRLTipoDocumentoC dGRLTipoDocumento = new TDGRLTipoDocumentoC();
  String cError = "";
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  Vector vcListado = dGRLTipoDocumento.findByCustom("iCveTipoDocumento","Select iCveTipoDocumento,cDscTipoDocumento,lActivo from GRLTipoDocumento " + oAccion.getCFiltro() + oAccion.getCOrden());
