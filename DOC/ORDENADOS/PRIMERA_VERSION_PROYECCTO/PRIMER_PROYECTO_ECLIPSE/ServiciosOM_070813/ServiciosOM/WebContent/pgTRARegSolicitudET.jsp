...
<%
/**
 * <p>Title: pgTRARegSolicitudET.jsp</p>
 ...
 */
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  ...
  "join GRLUsuarioXOfic on GRLUsuarioXOfic.iCveOficina = TRARegSolicitud.iCveOficina " +
  "and GRLUsuarioXOfic.iCveDepartamento = TRARegSolicitud.iCveDepartamento " +
  "and GRLUsuarioXOfic.iCveUsuario = " + iCveUsuario + " " +
