 ...
 */
 ...
 /** Se realiza la actualización de Datos a través de actualizar el vector con el Query */
  String cSQL = "SELECT ICVETRAMITE, ICVETRAMITEPADRE, LTRAMITEFINAL, CCVEINTERNA || ' '||CDSCBREVE AS CDSCBREVE, CCVEINTERNA,CBIENBUSCAR FROM TRACATTRAMITE where LVIGENTE = 1 order by ICVETRAMITEPADRE";
