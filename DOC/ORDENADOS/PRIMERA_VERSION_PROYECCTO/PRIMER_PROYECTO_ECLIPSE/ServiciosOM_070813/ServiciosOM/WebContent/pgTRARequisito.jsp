 ...
 * <p>Description: JSP "Catálogo" de la entidad TRARequisito</p>
 ...
 */
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    ...
    //FCSReq1 -Se Agrego el Campo cMetodoEjecuta-
        ...
        vDinRep = oAccion.setInputs("cDscRequisito,cDscBreve,cFundLegal,lVigente,lDigitaliza,iCveFormato,cMetodoEjecuta");
 ...
 /** Verifica si la Acción a través de hdBotón es igual a "GuardarA" (Actualizar) */
  if(oAccion.getCAccion().equals("GuardarA")){
    vDinRep = oAccion.setInputs("iCveRequisito,cDscRequisito,cDscBreve,cFundLegal,lVigente,lDigitaliza,iCveFormato,cMetodoEjecuta");
    try{
