...
<%
/**
 * <p>Title: pgTRAEtapaXModTramA1.jsp</p>
 ...
 */
  ...
  if(oAccion.getCAccion().equals("Guardar")){
    vDinRep = oAccion.setInputs("iOrden,lObligatorio,lVigente");
    try{
 ...
 String cSql=" Select icvetramite,icvemodalidad,traetapaxmodtram.icveetapa,lobligatorio,traetapaxmodtram.lvigente,cdscetapa "+
