...
public class TFooterWord {
    ...
    public void processFile() {
        ...
        try {
            ...
            //System.out.println("FirstFooter::" + hd.getOddFooter());
                        
            rangeFoot = hd.getRange();                       
            
            int count=0;
            paraTextFoot = this.loadParagraphs(rangeFoot);
            System.out.println("+++++++++++++paraTextFoot.length:"+paraTextFoot.length);
            for(int x = 0; x < paraTextFoot.length; x++) {            
            	...
            	for (Iterator iterator = this.keys.iterator(); iterator.hasNext();) {
                    ...
                    if(paraTextFoot[x].getUpdatedText().contains(key)) {
                    	System.out.println(">>>>>>>>>>>>key:"+key+"--"+"x:"+x+" (String) this.replacementText.get(key):"+(String) this.replacementText.get(key));
                ...
                if(paraTextFoot[x].isUpdated()) {
                	count++;
                	System.out.println("entro a reemplazar::" + count);
    ...
    private ParagraphText getTextFromPieces() {
    	System.out.println("--------------getTextFromPieces");
