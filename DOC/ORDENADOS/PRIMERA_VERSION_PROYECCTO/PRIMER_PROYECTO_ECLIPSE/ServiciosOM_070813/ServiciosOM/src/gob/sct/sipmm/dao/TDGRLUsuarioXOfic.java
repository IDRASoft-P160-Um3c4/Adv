...
/**
 * <p>Title: TDGRLUsuarioXOfic.java</p>
 ...
 * @version 1.0
 */
public class TDGRLUsuarioXOfic extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL =
          "insert into GRLUsuarioXOfic(iCveOficina,iCveDepartamento,iCveUsuario,cTelefono,cCorreoE) values (?,?,?,?,?)";

      //AGREGAR AL ULTIMO ...
      Vector vcData = findByCustom("","select MAX(iCveOficina) AS iCveOficina from GRLUsuarioXOfic");
      if(vcData.size() > 0){
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update GRLUsuarioXOfic set cTelefono=?, cCorreoE=? where iCveOficina = ? AND iCveDepartamento = ? AND iCveUsuario = ? ";
 ...
 public boolean checkUserByOffice( int iCveUser ) throws DAOException{
   DbConnection dbConn = null;
   ...
   try{
     ...
     String lSQL =
         " SELECT of.iCveCategoria "+
         " FROM GRLOficina of "+
         " JOIN GRLUsuarioXOfic uxo ON uxo.iCveOficina = of.iCveOficina "+
                                 " AND uxo.iCveUsuario = "+iCveUser+
         " WHERE iCveCategoria = 1 ";
