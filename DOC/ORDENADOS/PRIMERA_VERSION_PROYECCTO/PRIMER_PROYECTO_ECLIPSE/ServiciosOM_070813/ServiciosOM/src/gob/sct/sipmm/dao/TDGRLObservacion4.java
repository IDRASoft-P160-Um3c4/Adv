 ...
 * @version 1.0
 */
public class TDGRLObservacion4 extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      Vector vcdData = findByCustom(""," select * from CVHReparacion  where "+
      ...
      TDCVHReparacion dCVHDatosCalifica = new TDCVHReparacion();
