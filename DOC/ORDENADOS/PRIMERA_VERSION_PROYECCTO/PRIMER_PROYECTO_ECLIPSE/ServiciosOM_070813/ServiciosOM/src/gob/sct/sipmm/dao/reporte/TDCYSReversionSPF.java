...
public class TDCYSReversionSPF extends DAOBase{
  ...
  public TDCYSReversionSPF(){
  }


  //public Vector genReversionPFP(String cQuery,String cNumFolio,String cCveOficinaOrigen,String cCveDeptoOrigen){
    public Vector genReversionSPF(String cQuery,String cNumFolio,String cCveOficinaOrigen,String cCveDeptoOrigen){
      ...
      if (vRegs.size() > 0){
        ...
        else rep.comRemplaza("[cFechaTitulo]","__________________");


        if(vNotifRec.size()>0){
          TVDinRep vDinNotifRec = new TVDinRep();   //dtPublicacionDOF
          ...
          else rep.comRemplaza("[cFechaFolio]","_____________________");
          ...
          rep.comRemplaza("[cFechaFolio]","_____________________");
          rep.comRemplaza("[cFechaNotif]","_____________________");
        }
