...
System.out.println("GenOpiniones 1");
     TWord rep = new TWord();
     rep.iniciaReporte();
...
System.out.println("GenOpiniones 2");
     if (vRegs.size() > 0){
          TVDinRep vDatos = (TVDinRep) vRegs.get(0);
          System.out.println("GenOpiniones 3");
          ...
          if(vRegsPtoTerminal.size()>0){
            ...
            int iCuentaMarina = 0;
            System.out.println("GenOpiniones 4");
            ...
            System.out.println("GenOpiniones 4.1 --" + cTextoMarinas + "--");
            ...
            System.out.println("GenOpiniones 5 -- " + cTextoPuertos + "--" + cTextoTerminales + "--" + cTextoMarinas);
          }
          ...
          System.out.println("GenOpiniones 6");
     }else {
     ...
     System.out.println("GenOpiniones 7");
