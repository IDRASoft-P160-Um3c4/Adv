...
/**
 * <p>Title: TDGRLObservacion2.java</p>
 ...
 * @version 1.0
 */
public class TDGRLObservacion2 extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    String cEjercicio = cDmy.substring(6);
      ...
      String lSQL =
          "insert into GRLObservacion(iEjercicio,iCveObservacion,cObsRegistrada) values (?,?,?)";



      //AGREGAR AL ULTIMO ...
      Vector vcData = findByCustom("","select MAX(iCveObservacion) AS iCveObservacion from GRLObservacion where iEjercicio = "+cEjercicio);
      if(vcData.size() > 0){
      ...
      lPStmt.setString(3,vData.getString("cObsRegistrada"));
