 ...
 * <p>Description: DAO de la entidad TRACatTramite2para agreagr fuincionalidad de arbol a los tramites</p>
 * <p>Copyright: Copyright (c) 2010 </p>
 * <p>Company: INFOTEC</p>
 * @author ISM
 * @version 1.0
 */
public class TDTRACatTramite2A extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL =
          "insert into TRACatTramite(iCveTramite,cCveInterna,cDscTramite,cDscBreve,lReqFirmaDigital,lVigente,cBienBuscar,cObjetivoTramite,cComprobante,cNotas, ICVETRAMITEPADRE, LTRAMITEFINAL,lImprimeManual,iCveUsuario,tsModificacion) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      ...
      lPStmt.setInt(11,vData.getInt("iCveTramite2"));
      lPStmt.setInt(12,vData.getInt("lTramiteFinal"));
      lPStmt.setInt(13,vData.getInt("lImprimeManual"));
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update TRACatTramite set cCveInterna=?, cDscTramite=?, cDscBreve=?, lReqFirmaDigital=?, lVigente=?, cBienBuscar=?, cObjetivoTramite=?, cComprobante=?, cNotas=?, ICVETRAMITEPADRE=?, LTRAMITEFINAL=?,lImprimeManual=?,iCveUsuario=?,tsModificacion=? where iCveTramite = ? ";
      ...
      lPStmt.setInt(10,vData.getInt("iCveTramite2"));
      lPStmt.setInt(11,vData.getInt("lTramiteFinal"));
      lPStmt.setInt(12,vData.getInt("lImprimeManual"));
      lPStmt.setInt(13,vData.getInt("iCveUsuario"));
      lPStmt.setTimestamp(14,fecha.getThisTime());
      lPStmt.setInt(15,vData.getInt("iCveTramite"));
      lPStmt.executeUpdate();
      if(cnNested == null){
        conn.commit();
      }
