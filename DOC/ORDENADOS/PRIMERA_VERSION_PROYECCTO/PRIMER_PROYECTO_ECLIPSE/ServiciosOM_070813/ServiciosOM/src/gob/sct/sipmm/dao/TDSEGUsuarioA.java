...
public class TDSEGUsuarioA extends DAOBase {
 ...
 public TVDinRep upDateA(TVDinRep vData,Connection cnNested) throws DAOException{
    ...
    if(vcData.size()>0 && !lError){
      System.out.println("*****    Tamaño del vector: "+vcData.size());
       ...
       if(cErrores!="")
         System.out.println("Errores presentados\n"+cErrores);
    }
      return vData;
  }
  public String usrUpdate(TVDinRep vD, Connection cnNested){
    ...
    try{
      ...
      System.out.println("*****     Actualizando usuario: "+vD.getInt("ICVEUSUARIO")+": "+vD.getString("CUSUARIO"));
  ...
  public String usrInsert(TVDinRep vD, Connection cnNested){
    ...
    try{
      ...
      System.out.println("*****     Insertando usuario: "+vD.getInt("ICVEUSUARIO")+": "+vD.getString("CUSUARIO"));
      lPStmt.executeUpdate();
      lPStmt.close();
      if(cnNested == null){
        conn.commit();
