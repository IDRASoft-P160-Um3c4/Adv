...
//      System.out.println("------------iConsecutivoPNC: " + vData.getInt("iConsecutivoPNC"));
      lPStmt.setInt(3,vData.getInt("iCveProducto"));
//      System.out.println("------------iCveProducto: " + vData.getInt("iCveProducto"));
      lPStmt.setInt(4,vData.getInt("iCveCausaPNC"));
//      System.out.println("------------iCveCausaPNC: " + vData.getInt("iCveCausaPNC"));
      lPStmt.setInt(5,vData.getInt("iCveRequisito"));
//      System.out.println("iRequisito: " + vData.getInt("iCveRequisito"));
