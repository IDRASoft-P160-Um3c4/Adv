    ...
    private TVDinRep getDatosPersona(){
      ...
      if (iCveDomicilio > 0)
        cSql +=     " JOIN GRLDomicilio D ON D.iCvePersona = P.iCvePersona "+
                    ...
                    " JOIN GRLLocalidad LOC ON LOC.iCvePais = D.iCvePais AND LOC.iCveEntidadFed = D.iCveEntidadFed AND LOC.iCveMunicipio = D.iCveMunicipio AND LOC.iCveLocalidad = d.iCveLocalidad "+
