...
public class TDGRLAseguradora extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      System.out.println("*****   iCveAseguradora "+vData.getString("iCveAseguradora"));
      System.out.println("*****   iCvePersona     "+vData.getString("iCvePersona"));
      System.out.println("*****   iCveDomicilio   "+vData.getString("iCveDomicilio"));
      System.out.println("*****   cObses          "+vData.getString("cObses"));
      System.out.println("*****   lActivo         "+vData.getString("lActivo"));
