...
//      conn.setTransactionIsolation(conn.TRANSACTION_SERIALIZABLE);
  ...
  public synchronized TVDinRep insertBatch(TVDinRep vData,Connection cnNested) throws DAOException{
    ...
    Vector vcOficXDepto = this.findByCustom("","SELECT iCveOficina,iCveDepartamento FROM GRLDEPTOXOFIC where ICVEOFICINA = "+vData.getInt("iCveOficinaUsr")+" AND ICVEDEPARTAMENTO = "+vData.getInt("iCveDeptoUsr"));
...
//        conn.setTransactionIsolation(conn.TRANSACTION_SERIALIZABLE);
      ...
      if(vcOficXDepto.size()>0)
        ...
        iCveDeptoOrigen  = Integer.parseInt(VParametros.getPropEspecifica("DeptoVentanillaUnica"));
      ...
      for(int i=0; i<aTramites.length; i++){
        ...
        if(vcOficXDepto.size()<=0)
          cDeptoResuelve  = VParametros.getPropEspecifica("DeptoVentanillaUnica");
        ...
        vEtapa.put("lAnexo", 0);
        vEtapa.put("cObservaciones", "Solicitud" + iEjercicio + "/" + iNumSolicitud + " registrada con fecha:" + tsRegistro.toString());
        try{
...
public java.sql.Date getFechaLimiteEntregaDocs(int iCveTramite, int iCveModalidad, java.sql.Date dtIni){
  ...
  public String getOficinaDeptoResuelve(int iCveOficinaOrigen, int iCveTramite){
    ...
    try{
      ...
      if (vData.size() > 0){
        ...
        cOficinaDepto = iCveOficinaOrigen + "," + VParametros.getPropEspecifica("DeptoVentanillaUnica");
    }catch(Exception e){
      cMensaje = e.getMessage();
    }
  ...
  public TVDinRep cambiaBien(TVDinRep vData,Connection cnNested) throws
      DAOException{
    DbConnection dbConn = null;
    Connection conn = cnNested;
    PreparedStatement lPStmt = null;
    ...
    try{
      ...
      String cLigadas = "SELECT "+
                        ...
                        "SELECT INUMSOLICITUDPRINC FROM TRASOLICITUDREL where iejercicio="+vData.getInt("iEjercicio")+
                        " and INUMSOLICITUDREL="+vData.getInt("iNumSolicitud")+") ";
      ...
      Bita.put("cLlaveReg",vData.getString("iEjercicio")+"/"+vData.getString("iNumSolicitud"));
      Bita.put("iTipoMov",2);
  ...
  public TVDinRep cambiaResolucion(TVDinRep vData,Connection cnNested) throws
	  DAOException{
	DbConnection dbConn = null;
	Connection conn = cnNested;
	PreparedStatement lPStmt = null;
  ...
  public TVDinRep integraSol(TVDinRep vData,Connection cnNested) throws
      DAOException{
    DbConnection dbConn = null;
    Connection conn = cnNested;
    PreparedStatement lPStmt = null;
    ...
    try{
      ...
      //String cSQL = "Select traregsolicitud where idbien="+vData.getInt("iCveVehiculoO");
      String lSQL = "update TRARegSolicitud set iIdBien = ?,cDscBien = ? where iEjercicio = ? and iNumSolicitud=?";
      lPStmt = conn.prepareStatement(lSQL);
      lPStmt.setInt(1,vData.getInt("iCveVehiculo"));
      lPStmt.setString(2,vData.getString("cNomEmbarcacion"));
  ...
  public TVDinRep integraSolicitante(TVDinRep vData,Connection cnNested) throws
	  DAOException{
	DbConnection dbConn = null;
	Connection conn = cnNested;
	PreparedStatement lPStmt = null;
  ...
  public TVDinRep cambiaSolicitante(TVDinRep vData,Connection cnNested) throws
      DAOException{
    DbConnection dbConn = null;
    Connection conn = cnNested;
    PreparedStatement lPStmt = null;
  ...
  public TVDinRep agregaSolicitante(TVDinRep vData,Connection cnNested) throws
      DAOException{
    DbConnection dbConn = null;
    Connection conn = cnNested;
    PreparedStatement lPStmt = null;
  ...
  public TVDinRep updateImpresoB(TVDinRep vData,Connection cnNested) throws
   ...
   public TVDinRep insertSolicitudesRel2(TVDinRep vData,Connection cnNested) throws
       DAOException{
     DbConnection dbConn = null;
     Connection conn = cnNested;
     PreparedStatement lPStmt = null;
   ...
   public int insertaCitaCIS(int oficinaUsr,int tramite,int modalidad,int solicitante, java.sql.Date dtCita){
    ...
    try{
      ...
      if(vcPersonaCIS.size()>0){
        ...
        cDomicilio = vPersonaCIS.getString("cDomicilio")+" "+vPersonaCIS.getString("cNumExterior");
        if(!vPersonaCIS.getString("cNumInterior").equals("") && !vPersonaCIS.getString("cNumInterior").equals("null"))
      ...
      if(lEjecutaCIS){
        ...
        else iCveInteresadoCIS = dCis.insertaInteresado(vPersonaCIS.getString("cRFC"),"",
                                                        vPersonaCIS.getString("CNOMRAZONSOCIAL"),vPersonaCIS.getString("cApPaterno"),vPersonaCIS.getString("cApMaterno"),
                                                        vPersonaCIS.getInt("iCvePais"),vPersonaCIS.getInt("iCveEntidadFed"),vPersonaCIS.getInt("iCveMunicipio"),
                                                        vPersonaCIS.getString("cColonia"),cDomicilio,vPersonaCIS.getString("CCODPOSTAL"),vPersonaCIS.getString("CTELEFONO"),vPersonaCIS.getString("CCORREOE"));
      ...
      //Invocacion WS CIS      	  
    	  ...
    	  //String wsdlUrl = "http://10.33.141.136:7010/cisws/gob.sct.cisws.ws." + "InsertaCita?WSDL";    	  
    	  
          WSInsertaCita service = new WSInsertaCita_Impl(wsdlUrl);
          WSInsertaCitaPort port = service.getWSInsertaCitaPort();

          
          iCveCitaCis = port.insertaCita(VParametros.getPropEspecifica("ConWSCisUsr"),
        		  VParametros.getPropEspecifica("ConWSCisPwd"),
                  iCveTramiteCis,
                  0,
                  1,
                  cApPaterno + " " + cApMaterno + " " + cNomPersona ,
                  iCveOficinaCis);
      }   
  ...
  public java.sql.Date actualizaFechaCompromiso(int iEjercicio, int iNumSolicitud,int iCveTramite, int iCveModalidad,int iCveOficinaOrigen) throws Exception{
    java.sql.Timestamp tsRegistro = tFecha.getThisTime(false);
    ...
    String iEtapaDespNotif = VParametros.getPropEspecifica("EtapaRecepcionDespuesNotificacion");
    String iEtapaModificacion = VParametros.getPropEspecifica("EtapaModificarTramite");
    DbConnection dbConn = null;
    ...
    dtEstimadaEntrega = this.getFechaLimiteTraslado(iCveOficinaOrigen,iCveTramite,iCveModalidad,dtRegistro);
    ...
    if(vcEtapaNotif.size()>0){
      ...
      if(vEtapaNotif.getInt("LIMPRESO")==0 || vEtapaNotif.getInt("iCveEtapa")==Integer.parseInt(iEtapaDespNotif) || vEtapaNotif.getInt("iCveEtapa")==Integer.parseInt(iEtapaModificacion)){
        lUpdateEtapa=true;
  ...
  * @return TVDinRep           - VO Dinámico que contiene a la entidad a Insertada, así como a la llave de esta entidad.
  */
 public synchronized TVDinRep insertBatch2(TVDinRep vData,Connection cnNested) throws DAOException{
   DbConnection dbConn = null;
   Connection conn = cnNested;
   PreparedStatement lPStmt = null, lPStmt2 = null;
   boolean lSuccess = true;
   ...
   //System.out.println("" + vData.ge
   String[] aTramites, aModalidades, aRequisitos, aReqTemp, aReqValor, aEnvObl, aCarac, aReqCarac, aCaracTemp, aCarValor;
   Vector vcCaracPNC = new Vector();
   //String cSQLMax = "SELECT MAX(iNumSolicitud) AS iNumSolicitud FROM TRARegSolicitud WHERE iEjercicio = " + iEjercicio;
   String cSQLTra = "INSERT INTO TRARegSolicitud(iEjercicio,iNumSolicitud,iCveTramite,iCveModalidad,iCveSolicitante,"+
       "iCveRepLegal,cNomAutorizaRecoger,iCveUsuRegistra,tsRegistro,dtLimiteEntregaDocs,dtEstimadaEntrega,lPagado,"+
   ...
   String cSQLdtEstPrin = " UPDATE TRARegSolicitud SET dtEstimadaEntrega=? " +
                          " WHERE iEjercicio=? AND iNumSolicitud=? ";
   Vector vcOficXDepto = this.findByNessted("","SELECT iCveOficina,iCveDepartamento FROM GRLDEPTOXOFIC where ICVEOFICINA = "+vData.getInt("iCveOficinaUsr")+" AND ICVEDEPARTAMENTO = "+vData.getInt("iCveDeptoUsr"),conn);
...
//        conn.setTransactionIsolation(conn.TRANSACTION_SERIALIZABLE);
     ...
     for(int i=0; i<aTramites.length; i++){
       ...
       // modificar cuando se defina la forma de localizar la cita o de registrarla
       // ya no se encontro, pero se crea la cita en una fase posterior de este mismo proceso.
       lPStmt.setInt(20,0); // iEjercicioCita
       lPStmt.setInt(21,0); // iIdCita
       ...
       try{
    	   dEtapaIni.incertaEstadoCita(iEjercicio,iNumSolicitud,iCveEtapa,conn);
       }catch(Exception e){
           e.printStackTrace();
       }
       ...
       /***************  REGISTRO DE REQUISITOS EN EL TRÁMITE   ***************/
       int iRequisito;
       ...
       for(int k = 0;k < aReqTemp.length;k++){
         ...
         iRequisito = Integer.parseInt(aReqValor[0],10);
         sRequisitos += sRequisitos==""?""+iRequisito:","+iRequisito;
       }
              
       String sReq = "SELECT ICVEREQUISITO,LREQUERIDO FROM TRAREQXMODTRAMITE "+
                     "where ICVETRAMITE="+Integer.parseInt(aTramites[i],10)+
                     " and icvemodalidad ="+Integer.parseInt(aModalidades[i],10)+
 ...
 public TVDinRep fGenSolicitudRel(TVDinRep vData,Connection cnNested){
   ...
   java.sql.Date dtLimEntregaDoctos = this.getFechaLimiteEntregaDocs(Integer.parseInt(vData.getString("ClavesTramite")), Integer.parseInt(vData.getString("ClavesModalidad")), dtActual);
   String cSQL = "SELECT ICVETRAMITEHIJO,ICVEMODALIDADHIJO FROM TRADependencia " +
                 "where ICVETRAMITE="+vData.getString("ClavesTramite")+" and ICVEMODALIDAD= "+vData.getString("ClavesModalidad");
   ...
   try{
     ...
     for(int i=0;i<vcTramitesRel.size();i++){
       ...
       vData.put("ClavesModalidad",vDinRep.getString("ICVEMODALIDADHIJO"));
   ...
   vData.put("cNumSolicitudes",cSol);
   }
   catch(Exception ex){
     ex.printStackTrace();
     cMensaje = ex.getMessage();
 ...
 public java.sql.Date getFechaCompromiso(int iEjercicio, int iNumSolicitud,Connection cnNested) throws Exception{
   ...
   String cPadre = "SELECT INUMSOLICITUDPRINC " +
                   "FROM TRASOLICITUDREL " +
                   "where IEJERCICIO=" + iEjercicio + " and INUMSOLICITUDREL=" +iNumSolicitud;
   ...
   if(vcPadre.size()>0){
     ...
     cSql = "SELECT " +
                 ...
                 "where S.IEJERCICIO =" + iEjercicio + " AND S.INUMSOLICITUD= " + vPadre.getInt("INUMSOLICITUDPRINC");
                 /*
   ...
   for (int iN=0;iN<vcNotif.size();iN++){
	   ...
	   iNotif += fecha.getDaysBetweenDates(vNotif.getDate("DTREGISTRO"), vNotif.getDate("DTRESOLUCION"));
   }
   ...
   if(vcTrami.size() > 0){
     ...
     for(int i=0;i<vcTrami.size();i++){
       ...
       diasReso =    diasReso>vTramiTemp.getInt("INUMDIASRESOL")?diasReso:vTramiTemp.getInt("INUMDIASRESOL");
       diasIda =     diasIda>vTramiTemp.getInt("IDIASIDA")?diasIda:vTramiTemp.getInt("IDIASIDA");
       diasRetorno = diasRetorno>vTramiTemp.getInt("IDIASRETORNO")?diasRetorno:vTramiTemp.getInt("IDIASRETORNO");
       diasNot =     diasNot>vTramiTemp.getInt("dtNotif")?diasNot:vTramiTemp.getInt("dtNotif");
     }
     if(diasReso > 0){
       dtRetorno = diaNoHabil.getFechaFinal(dtRetorno,diasReso,(vTrami.getInt("LDIASNATURALESRESOL") ==1 ? true : false));
     }
     if(diasIda > 0){
       dtRetorno = diaNoHabil.getFechaFinal(dtRetorno,diasIda,(vTrami.getInt("LDIASNATURALESTRASLADO") == 1 ? true : false));
     }
     if(diasRetorno > 0){
       dtRetorno = diaNoHabil.getFechaFinal(dtRetorno,diasRetorno,(vTrami.getInt("LDIASNATURALESRET") == 1 ? true : false));
     }
     if(diasNot > 0){
 ...
 public void updateFechaCompromiso(int iEjercicio,int iNumSolicitud,Connection cnNested)throws DAOException{
	DbConnection dbConn = null;
	Connection conn = cnNested;
	PreparedStatement lPStmt = null;
	TDGRLBitacora bitacora = new TDGRLBitacora();
	...
	try{
	 ...
	 lPStmt.setDate(1,this.getFechaCompromiso(iEjercicio, iNumSolicitud, conn));
	 lPStmt.setInt(2,iEjercicio);
	 lPStmt.setInt(3,iNumSolicitud);
 ...
 public void fechaImpresion(int iEjercicio,int iNumSolicitud,Connection cnNested)throws DAOException{
