...
/**
 * <p>Title: TDTRARegSolicitudA1.java</p>
 ...
 * @version 1.0
 */
public class TDTRARegSolicitudA1 extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      lPStmt.setInt(24,vData.getInt("iEjercicio"));
      lPStmt.setInt(25,vData.getInt("iNumSolicitud"));
      lPStmt.setInt(26,vData.getInt("iCveTramite"));
      lPStmt.setInt(27,vData.getInt("iCveModalidad"));
      lPStmt.setInt(28,vData.getInt("iCveSolicitante"));
      lPStmt.setInt(29,vData.getInt("iCveRepLegal"));
      lPStmt.setString(30,vData.getString("cNomAutorizaRecoger"));
      lPStmt.setInt(31,vData.getInt("iCveUsuRegistra"));
      lPStmt.setString(32,vData.getString("tsRegistro"));
      lPStmt.setDate(33,vData.getDate("dtLimiteEntregaDocs"));
      lPStmt.setDate(34,vData.getDate("dtEstimadaEntrega"));
      lPStmt.setInt(35,vData.getInt("lPagado"));
      lPStmt.setDate(36,vData.getDate("dtEntrega"));
      lPStmt.setInt(37,vData.getInt("iCveUsuEntrega"));
      lPStmt.setInt(38,vData.getInt("lResolucionPositiva"));
      lPStmt.setInt(39,vData.getInt("lDatosPreregistro"));
      lPStmt.setInt(40,vData.getInt("iIdBien"));
      lPStmt.setInt(41,vData.getInt("iCveOficina"));
      lPStmt.setInt(42,vData.getInt("iCveDepartamento"));
      lPStmt.setInt(43,vData.getInt("iEjercicioCita"));
      lPStmt.setInt(44,vData.getInt("iIdCita"));
      lPStmt.setInt(45,vData.getInt("iCveForma"));
      lPStmt.setInt(46,vData.getInt("lPrincipal"));
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      lPStmt.setInt(24,vData.getInt("iCveTramite"));
      lPStmt.setInt(25,vData.getInt("iCveModalidad"));
      lPStmt.setInt(26,vData.getInt("iCveSolicitante"));
      lPStmt.setInt(27,vData.getInt("iCveRepLegal"));
      lPStmt.setString(28,vData.getString("cNomAutorizaRecoger"));
      lPStmt.setInt(29,vData.getInt("iCveUsuRegistra"));
      lPStmt.setString(30,vData.getString("tsRegistro"));
      lPStmt.setDate(31,vData.getDate("dtLimiteEntregaDocs"));
      lPStmt.setDate(32,vData.getDate("dtEstimadaEntrega"));
      lPStmt.setInt(33,vData.getInt("lPagado"));
      lPStmt.setDate(34,vData.getDate("dtEntrega"));
      lPStmt.setInt(35,vData.getInt("iCveUsuEntrega"));
      lPStmt.setInt(36,vData.getInt("lResolucionPositiva"));
      lPStmt.setInt(37,vData.getInt("lDatosPreregistro"));
      lPStmt.setInt(38,vData.getInt("iIdBien"));
      lPStmt.setInt(39,vData.getInt("iCveOficina"));
      lPStmt.setInt(40,vData.getInt("iCveDepartamento"));
      lPStmt.setInt(41,vData.getInt("iEjercicioCita"));
      lPStmt.setInt(42,vData.getInt("iIdCita"));
      lPStmt.setInt(43,vData.getInt("iCveForma"));
      lPStmt.setInt(44,vData.getInt("lPrincipal"));
      lPStmt.setInt(45,vData.getInt("iEjercicio"));
      lPStmt.setInt(46,vData.getInt("iNumSolicitud"));
      lPStmt.executeUpdate();
      if(cnNested == null){
        conn.commit();
      }
