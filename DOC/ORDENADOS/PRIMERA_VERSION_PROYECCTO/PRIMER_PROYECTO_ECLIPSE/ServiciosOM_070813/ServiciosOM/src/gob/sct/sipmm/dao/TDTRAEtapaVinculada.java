...
public class TDTRAEtapaVinculada extends DAOBase{
  ...
  public boolean delete(TVDinRep vData,Connection cnNested)throws
    ...
    try{
      ...
      System.out.println("*****     Tramite: "+vData.getInt("iCveTramite"));
      System.out.println("*****     Modalidad: "+vData.getInt("iCveModalidad"));
      System.out.println("*****     TramiteH: "+vData.getInt("iTramHijo"));
      System.out.println("*****     ModalidadH: "+vData.getInt("iModHijo"));
      System.out.println("*****     Etapa: "+vData.getInt("iCveEtapa"));
