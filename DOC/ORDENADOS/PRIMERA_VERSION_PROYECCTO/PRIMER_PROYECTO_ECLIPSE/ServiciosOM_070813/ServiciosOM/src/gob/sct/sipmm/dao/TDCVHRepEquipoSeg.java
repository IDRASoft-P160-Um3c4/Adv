...
/**
 * <p>Title: TDCVHRepEquipoSeg.java</p>
 * <p>Description: DAO de la entidad CVHRepEquipoSeg</p>
 * <p>Copyright: Copyright (c) 2005 </p>
 * <p>Company: Tecnología InRed S.A. de C.V. </p>
 * @author Hanksel Fierro Medina
 * @version 1.0
 */
public class TDCVHRepEquipoSeg
    extends DAOBase{
   ...
   * <p><b> insert into CVHRepEquipoSeg(iCveVehiculo,iEjercicioReporte,iMesReporte,iCveUsuRegistra,dtRegistro,iEjercicioObs,iCveObservacion,lConcluido,iCveUsuValida,dtValidacion) values (?,?,?,?,?,?,?,?,?,?) </b></p>
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL =
          "insert into CVHRepEquipoSeg(iCveVehiculo,iEjercicioReporte,iMesReporte,iCveUsuRegistra,dtRegistro,iEjercicioObs,iCveObservacion) values (?,?,?,?,(CURRENT DATE),YEAR(CURRENT DATE),?)";

      //AGREGAR AL ULTIMO ...

      //...

      Vector vcData = findByCustom(""," select * from CVHRepEquipoSeg  where " +
      ...
      if(vcData.size() == 0){
        ...
        TDCVHDatosRepSeg dCVHDatosCalifica = new TDCVHDatosRepSeg();
   ...
   * <p><b> delete from CVHRepEquipoSeg where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ?  </b></p>
   * <p><b> Campos Llave: iCveVehiculo,iEjercicioReporte,iMesReporte, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public boolean delete(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "delete from CVHRepEquipoSeg where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ?  ";
      //...
   ...
   * <p><b> update CVHRepEquipoSeg set iCveUsuRegistra=?, dtRegistro=?, iEjercicioObs=?, iCveObservacion=?, lConcluido=?, iCveUsuValida=?, dtValidacion=? where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ?  </b></p>
   * <p><b> Campos Llave: iCveVehiculo,iEjercicioReporte,iMesReporte, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update CVHRepEquipoSeg set  lConcluido=1, iCveUsuValida=?, dtValidacion=(CURRENT DATE) where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ? ";
  ...
  public TVDinRep insertUpdateBatch(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      int iEjercicioObs = 0,
        iCveObservacion = 0;
      TDCVHDatosRepSeg dDatosRepSeg = new TDCVHDatosRepSeg();
      if(cnNested == null){
        dbConn = new DbConnection(dataSourceName);
        conn = dbConn.getConnection();
        conn.setAutoCommit(false);
      ...
      if(vcData.size() == 0){
        String lSQL = "insert into CVHRepEquipoSeg(iCveVehiculo,iEjercicioReporte,iMesReporte," +
        ...
        String lSQL = "update CVHRepEquipoSeg set iEjercicioObs=?,"+
      ...
      try{
        dDatosRepSeg.insertUpdateBatch(vData,conn);
      }catch(Exception e){
        e.printStackTrace();
      }
      if(cnNested == null)
  ...
  public TVDinRep concluyeReporte(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update CVHRepEquipoSeg set lConcluido=?, iCveUsuRegistra=?, dtRegistro=? where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ? ";
  ...
  public TVDinRep validaConcluye(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update CVHRepEquipoSeg set lConcluido=?, iCveUsuValida=?, dtValidacion=? where iCveVehiculo = ? AND iEjercicioReporte = ? AND iMesReporte = ? ";
