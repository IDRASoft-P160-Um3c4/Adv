...
public StringBuffer fAprobacionDocumentos(String cQuery){
      ...
      try{
        //System.out.println("*****    SupDireccionInspeccion  "+VParametros.getPropEspecifica("SupDireccionInspeccion"));
      ...
      try{
        ...
        //System.out.println("*****    SubDireccionIngNaval  "+cJefe);
      ...
      try{
        ...
        //System.out.println("*****    JefeDeptoInspeccion  "+cJefe);
...
//         rep.comDespliegaCombinado("NOMBRE DEL TECNICO","w",80,"ae",80,rep.getAT_HIZQUIERDA(),rep.getAT_VCENTRO(),true,15,true,false,1,1);
         ...
         int iReng=2;
         System.out.println("::Clave tipo Estacion::::::::" + vCertifIA.getInt("ICVETIPOESTACION"));
         //Caso 1
...
//Obras de Protección
       ...
       rep.iniciaReporte();
       //System.out.println("*****     "+iConsecutivoCertExp);
       String[] aParam = iConsecutivoCertExp.split(",");
...
public StringBuffer fReportGenCertificadoWord(String cQuery){
 ...
 rep.comRemplaza("[LetrasDistintivas]",vDatos.getString("cSenialDist"));
   ...
   //System.out.println("*****    Fecha de construccion  "+vDatos.getString("DTCONSTRUCCION"));
 ...
 rep.comRemplaza("[CDSCTIPONAVEGA]","_______________");
   ...
   //System.out.println("*****    Antes de imprimir el tipo servicio!!!!");
 ...
 rep.comRemplaza("[CDSCTIPOSERV]","_______________");
   ...
   //System.out.println("*****    Despues de imprimir los valores");
 }
 else {
