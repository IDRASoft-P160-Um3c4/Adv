 ...
 * @version 1.0
 */
public class TDGRLPersonaA extends DAOBase{
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update GRLPersona set cRFC=?, cRPA=?, iTipoPersona=?, cNomRazonSocial=?, cApPaterno=?, cApMaterno=?, cCorreoE=? where iCvePersona = ? ";
