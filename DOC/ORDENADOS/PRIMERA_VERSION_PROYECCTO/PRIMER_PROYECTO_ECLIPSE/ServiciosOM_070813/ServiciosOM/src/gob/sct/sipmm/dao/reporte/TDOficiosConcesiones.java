...
//		System.out.println("==============cNumFolio:"+cNumFolio);
//		System.out.println("==============iCveOficinaOrigen:"+iCveOficinaOrigen);
//		System.out.println("==============iCveDeptoOrigen:"+iCveDeptoOrigen);
		System.out.println("==============iCvePersona:"+iCvePersona);
		System.out.println("==============iCveDomicilio:"+iCveDomicilio);
		System.out.println("==============iCveRepLegal:"+iCveRepLegal);
...
//				rep.getEtiquetasBuscar(), rep.getEtiquetasRemplazar());
	...
	public Vector generaCesionDerechos(String cFiltro){
		//System.out.println("-------------------TDOficiosConcessiones-->cFiltro:"+cFiltro+"<-----");
		TWord rep = new TWord();
