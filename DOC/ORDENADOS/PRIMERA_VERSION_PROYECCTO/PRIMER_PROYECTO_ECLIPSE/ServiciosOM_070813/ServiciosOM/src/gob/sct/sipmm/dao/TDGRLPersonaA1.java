 ...
 * @version 1.0
 */
public class TDGRLPersonaA1 extends DAOBase{
   ...
   * <p><b> insert into GRLPersona(iCvePersona,cRFC,cRPA,iTipoPersona,cNomRazonSocial,cApPaterno,cApMaterno,cCorreoE) values (?,?,?,?,?,?,?,?) </b></p>
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL =
          "insert into GRLPersona(iCvePersona,crfc,crpa,itipopersona,cnomrazonsocial,cappaterno,capmaterno,ccorreoe,cpseudonimoemp,cCURP) values (?,?,?,?,?,?,?,?,?,?)";
      ...
      lPStmt.setString(10,vData.getString("cCURP"));
   ...
   * <p><b> update GRLPersona set cRFC=?, cRPA=?, iTipoPersona=?, cNomRazonSocial=?, cApPaterno=?, cApMaterno=?, cCorreoE=? where iCvePersona = ?  </b></p>
   * <p><b> Campos Llave: iCvePersona, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
