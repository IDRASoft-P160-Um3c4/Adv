...
public class TDGRLPersona extends DAOBase{
   ...
   * <p><b> insert into GRLPersona(iCvePersona,cRFC,cRPA,iTipoPersona,cNomRazonSocial,cApPaterno,cApMaterno,cCorreoE,cPseudonimoEmp) values (?,?,?,?,?,?,?,?,?) </b></p>
   ...
   * <p><b> update GRLPersona set cRFC=?, cRPA=?, iTipoPersona=?, cNomRazonSocial=?, cApPaterno=?, cApMaterno=?, cCorreoE=?, cPseudonimoEmp=? where iCvePersona = ?  </b></p>
   * <p><b> Campos Llave: iCvePersona, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
