...
public class TDINTSolicitud extends DAOBase {
    ...
    public TVDinRep insert(TVDinRep vData, Connection cnNested)
        ...
        int tramite  = 0;
        int etapa = 0; // Inicio de trámite por ventanilla
        int area  = 0; //DGAF
        ...
        try {
            ...
            if(vcSolicitud.size()>0){ 
            	...
            	if(vcArea.size()>0){
	                ...
	                vEtapas.put("iCveOficina",vArea.getInt("ICVEOFICINARESUELVE"));
	                vEtapas.put("iCveDepartamento",vArea.getInt("ICVEDEPTORESUELVE"));
            ...
            dCis.insertaEstadoTramite(vData.getInt("iNumCita"),tramite,1,etapa,cObservacion,area);
   ...
   return vData;
	...
	try {
	    ...
	    String lSQL = "INSERT INTO INTTRAMITEDOCS (ICVEDOCDIG,TSREGISTRO,CDOCUMENTO,CNOMARCHIVO,CCAMPO,IEJERCICIO,INUMSOLICITUD) VALUES (?,?,?,?,?,?,?)";
