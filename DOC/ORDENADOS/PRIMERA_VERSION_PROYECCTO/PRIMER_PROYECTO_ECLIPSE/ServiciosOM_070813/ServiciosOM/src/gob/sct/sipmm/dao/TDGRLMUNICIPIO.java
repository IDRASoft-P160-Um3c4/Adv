...
public class TDGRLMUNICIPIO extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      //En caso de ser secuencia verificar,
      //En caso contrario sustituir código...
      vData.put("ICVEPAIS",TablaSecuencia.getSecuencia(conn,"GRLMUNICIPIO"));
   ...
   * <p><b> delete from GRLMUNICIPIO where ICVEPAIS = ? </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public boolean delete(TVDinRep vData,Connection cnNested){
    ...
    try{
      ...
      String lSQL = "delete from GRLMUNICIPIO where ICVEPAIS = ?";
      //...
   ...
   * <p><b> update GRLMUNICIPIO set ICVEENTIDADFED=?, ICVEMUNICIPIO=?, CNOMBRE=?, CABREVIATURA=? where ICVEPAIS = ?  </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update GRLMUNICIPIO " +
          "set "+
"ICVEENTIDADFED=?,"+
"ICVEMUNICIPIO=?,"+
"CNOMBRE=?,"+
"CABREVIATURA=? "+
      ...
      lPStmt.setInt(2,vData.getInt("ICVEMUNICIPIO"));
