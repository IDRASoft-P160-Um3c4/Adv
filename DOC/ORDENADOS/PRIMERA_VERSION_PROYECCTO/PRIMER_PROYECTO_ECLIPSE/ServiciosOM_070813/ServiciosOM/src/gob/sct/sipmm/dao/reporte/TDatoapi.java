...
public class TDatoapi extends DAOBase {
	...
	public Vector fReporte(String cQuery, String cNumFolio,
		...
		if(OBJTITULO != ""){
			...
			//System.out.println("[ObjetoAutTec]" + OBJTITULO);
		}
		try {
			vRegs = super
					.FindByGeneric(
		...
		if (vRegs.size() > 0) {
			...
			//System.out.println("ICVEOPINIONENTIDAD" + ICVEOPINIONENTIDAD);
			//System.out.println("COPINIONDIRIGIDOA" + COPINIONDIRIGIDOA);
			//System.out.println("CPUESTOOPINION" + CPUESTOOPINION);
		...
		if(Observaciones.size()>0){
			...
			//System.out.println("ASUNTOLA" + ASUNTOLA);
			...
			//System.out.println("FECHASOL" + FECHASOL);
		}
		...
		if(Observaciones.size()>0){
			...
			//System.out.println("NUMPLANOS" + NUMPLANOS);
