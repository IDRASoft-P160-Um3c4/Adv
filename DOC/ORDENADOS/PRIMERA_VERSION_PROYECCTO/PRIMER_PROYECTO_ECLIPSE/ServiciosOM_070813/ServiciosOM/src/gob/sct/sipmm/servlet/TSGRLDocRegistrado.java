 ...
 * <p>Company: </p>
 * @author Tecnología InRed S.A. de C.V.<dd>Oscar Castrejón Adame<dd>Rafael Miranda Blumenkron
 * @version 1.0
 */
...
public class TSGRLDocRegistrado extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if (iUsoWebService == 1){
      iBaseGestor = 1;
      iTamañoArchivo = Integer.parseInt(vParametros.getPropEspecifica("TamArchivoCM").toString())*1024*1024;
    }
    else {
      iBaseGestor = 0;
      iTamañoArchivo = Integer.parseInt(vParametros.getPropEspecifica("TamArchivoDB").toString())*1024*1024;
    }
    System.out.println("..............TamArchivoDB--->"+iTamañoArchivo);
    ...
    try{
      if(request.getContentType() != null){
        ...
        mp = new MultipartParser(request, iTamañoArchivo);
          ...
          if(p.isParam()){
            ...
            if (p.getName().compareTo("cMimeType") == 0){
                ...
                if (pp.getStringValue().compareTo("") != 0){
                  ...
                  System.out.println("----------------pp.getStringValue(): "+pp.getStringValue());
...
//                               "" + Numeros.getNumeroSinSeparador(idGestor,iDigitos);
                ...
                System.out.println("++++++++++++---------String [] values: cMimeType: "+cMimeType);
            ...
            if (cAccion.compareTo("GuardarA") == 0){
              if (iUsoWebService == 0){
                ...
                String [] keys = {"userid", "password", "entity", "mimeType", "lintiCveDocumen"};
                System.out.println("++++++++++++---------String [] values 2 ----: cMimeType: "+cMimeType);
                //String [] values = {cUsrCM, cPwdCM, cEntidadCM, cMimeType, cFolioGestor };
                String [] values = {cUsrCM, cPwdCM, cEntidadCM, "application/octet-stream", cFolioGestor };
                String [] operators = {"", "", "", "", "", "="};
            ...
            if (cAccion.compareTo("Borrar")  == 0){
              if (iUsoWebService == 0){
                ...
                System.out.println("Falta Agregar el Uso del Web Service para Borrar Doctos");
              }
            }
...
//                            "" + Numeros.getNumeroSinSeparador(idGestor,iDigitos);
         ...
         System.out.println("--------->cFolioGestor: "+cFolioGestor);
         ...
         String[] operators = {"","","","","","="};
         try{
           System.out.println("---------------------> keys: "+keys.toString()+"    values: "+values.toString());
...
//    String cRutaFuncs = vParametros.getPropEspecifica("RutaFuncs");
    ...
    if (cAccion.compareTo("Consultar") == 0){
      System.out.println("Archivo existe=" + ((btArchivo != null)?"SI":"NO") + " MimeType="+cMimeType);
       if (btArchivo != null){
         if(cMimeType.equals(""))
