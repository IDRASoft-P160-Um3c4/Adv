...
/**
 * <p>Title: TDCYSRevocacion.java</p>
...
public class TDCYSRevocacion extends DAOBase{
	...
	public TDCYSRevocacion(){
	}

	public StringBuffer genInicioRevocacion(String cQuery,String cNumFolio,String cCveOficinaOrigen,String cCveDeptoOrigen){
			...
			if (vRegs.size() > 0){
				...
				rep.comDespliegaAlineado("F",iReng,"K",iReng,"Asunto: Se Inicia Procedimiento Administrativo de Revocación.",true,rep.getAT_HIZQUIERDA(),rep.getAT_VSUPERIOR());
				iReng+=2;
	...
	//			MaritimoTerrestre			
			...
			String cPrimerParrafoFin = "Las omisiones anteriores, implican el incumplimiento de las condiciones antes señaladas " +
					"del título y de las obligaciones legales mencionadas y constituyen causa de revocación, conforme a lo " +
					"establecido en el artículo 33 de la Ley de Puertos, por lo que se inicia el procedimiento de revocación, " +
					"previsto en el artículo 34 de dicha Ley y se le concede un plazo de 15 días hábiles contados a partir de la " +
					"notificación del presente, para que manifieste lo que a su derecho convenga, haga valer sus defensas y " +
					"presente pruebas conforme a la Ley, apercibido de que al vencimiento de este plazo, con o sin ellas, se " +
					"emitirá la resolución que en derecho proceda.";
	
			iReng++;
			rep.comDespliegaAlineado("B", iReng,"K",iReng+6,cPrimerParrafoFin,false,rep.getAT_COMBINA_IZQUIERDA(),rep.getAT_VSUPERIOR());
			rep.comAlineaRango("B",iReng,"K",iReng + 6,rep.getAT_HJUSTIFICA());
			iReng+=8;
			String cSegundoParrafoFin = "Lo anterior con fundamento en los artículos 14 y 16 de la Constitución Política de los " +
					...
					"1º, 2°, 3º, 16, fracción IV, 26, 33, 34, 37 de la Ley de Puertos; y 27 fracciones I, IV, XI y XX del " +
	...
	//		Remitente y Pie de Página
			...
			iReng+=3;
			rep.comDespliegaAlineado("B", iReng,"I",iReng,"c.c.p.	C. Coordinador General de Puertos y Marina Mercante. Presente",false,rep.getAT_HIZQUIERDA(),rep.getAT_VSUPERIOR());
			iReng++;
			rep.comDespliegaAlineado("B", iReng,"I",iReng,"ACN/AECHR",false,rep.getAT_HIZQUIERDA(),rep.getAT_VSUPERIOR());
			iReng++;
			rep.comDespliegaAlineado("B", iReng,"I",iReng,"Inicio Revocación (nombre o razón)",false,rep.getAT_HIZQUIERDA(),rep.getAT_VSUPERIOR());
			iReng++;
	...
	public Vector genInicioRevocacionWord(String cQuery,String cNumFolio,String cCveOficinaOrigen,String cCveDeptoOrigen){
		...
		String cAsunto="Se Inicia Procedimiento Administrativo de Revocación.";
