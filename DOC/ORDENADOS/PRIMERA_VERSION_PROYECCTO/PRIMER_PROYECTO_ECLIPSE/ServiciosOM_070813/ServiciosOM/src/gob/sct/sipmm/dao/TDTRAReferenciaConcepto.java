...
public class TDTRAReferenciaConcepto extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    System.out.println("*****     Año Actual:  "+iAnioActual);
    Date dtIniAnioSig = new Date((iAnioActual-1900+1),0,1);
    System.out.println("*****     Fecha inicio Año siguiente:  "+dtIniAnioSig);
    try{
      if(cnNested == null){
  ...
  public boolean delete(TVDinRep vData,Connection cnNested)throws
    ...
    try{
      ...
      //...
//System.out.println(" **** iEjercicio="+vData.getInt("iEjercicio")+"  iCveConcepto=" + vData.getInt("iCveConcepto")+"dtIniVigencia="+vData.getString("dtIniVigenciaIzq"));
      lPStmt = conn.prepareStatement(lSQL);
