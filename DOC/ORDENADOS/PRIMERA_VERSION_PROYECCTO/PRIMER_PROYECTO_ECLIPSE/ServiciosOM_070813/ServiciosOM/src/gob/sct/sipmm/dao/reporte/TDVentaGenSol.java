    ...
    if(cMensaje.equals("")){
      ...
      try{
        ...
        for(int j = 0;j < aSolicitudes.length;j++){
          ...
          vGenerales = tTramite.getDatosGeneralesSolicitud(cWhere,cOrder,lSolicRepLegal);
            ...
            if(vRequisitos != null && vRequisitos.size() > 0){ // Datos de Requisitos
              ...
              for(int i = 0;i < vRequisitos.size();i++){
                ...
                if(cTemp.equals("NO ENTREGADO") && regRequisito.getInt("lRequerido") == 1){
                  System.out.println("*****     Improcedente por Requisitos incompletos");
                  lImprocedente = true;
                ...
                if(vAnticipadosPorPagar.size()>0){
                  ...
                  for(int inc = 0;inc < vAnticipadosPorPagar.size();inc++){
                    ...
                    if(vConceptos.getInt("ICVEGRUPO")==0 &&  vConceptos.getInt("CONCEPTOPAGADO")==0){
                      lImprocedente = true;
                      System.out.println("*****     Improcedente por Conceptos no pagados.");
                    }
                    if(iGpoPagado>=0){
                      if(vConceptos.getInt("ICVEGRUPO") != 0 &&
                         ...
                         vConceptos.getInt("ICVEGRUPO") != iGpoPagado){
                           lImprocedente = true;
                           System.out.println("*****     Improcedentes por grupos no pagados");
                      }
                    }
                  }
                }
              if(iNumeroReporte == 1){
                ...
                if(vSQLPNC.size() > 0){
                  lImprocedente = true;
                  System.out.println("*****     Improcedente por PNC");
                }
              }
...
//    dtOficioSolROP = tFecha.getDateSQL(cdtOficioSol);
    ...
    try{
      ...
      sbBuscaAdic.append("[iEjercicioSolicitud]|[iNumSolicitud]|[dtSolicitud]|[cTramite]|[cDscBien]|")
          ...
          .append("[cEntidad]|[cMunicipio]|[numDiasNot]|")
          ;
      sbReemplazaAdic.append(String.valueOf(iEjercicioSolicitud) + "|" + (String.valueOf(iNumSolicitud)) + "|")
          ...
          .append(cCodPostal + "|" + cPais + "|" + cEntidad + "|" + cMunicipio + "|" + iDiasDespNotificado + "|");
