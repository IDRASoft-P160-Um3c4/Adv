...
/**
 * <p>Title: pgTRARegSolicitud1A.java</p>
 ...
 * @version 1.0
 */
public class TDTRARegSolicitud1A extends DAOBase{
   ...
   * <p><b> insert into TRARegSolicitud(iEjercicio,iNumSolicitud,iCveTramite,iCveModalidad,iCveSolicitante,iCveRepLegal,cNomAutorizaRecoger,iCveUsuRegistra,tsRegistro,dtLimiteEntregaDocs,dtEstimadaEntrega,lPagado,dtEntrega,iCveUsuEntrega,lResolucionPositiva,lDatosPreregistro,iIdBien,iCveOficina,iCveDepartamento,iEjercicioCita,iIdCita,iCveForma,lPrincipal,lImpreso,iCveDomicilioSolicitante,iCveDomicilioRepLegal) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) </b></p>
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL =
          "insert into TRARegSolicitud(iEjercicio,iNumSolicitud,iCveTramite,iCveModalidad,iCveSolicitante,iCveRepLegal,cNomAutorizaRecoger,iCveUsuRegistra,tsRegistro,dtLimiteEntregaDocs,dtEstimadaEntrega,lPagado,dtEntrega,iCveUsuEntrega,lResolucionPositiva,lDatosPreregistro,iIdBien,iCveOficina,iCveDepartamento,iEjercicioCita,iIdCita,iCveForma,lPrincipal,lImpreso,iCveDomicilioSolicitante,iCveDomicilioRepLegal) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      ...
      lPStmt.setInt(24,vData.getInt("lImpreso"));
      lPStmt.setInt(25,vData.getInt("iCveDomicilioSolicitante"));
      lPStmt.setInt(26,vData.getInt("iCveDomicilioRepLegal"));
   ...
   * <p><b> update TRARegSolicitud set iCveTramite=?, iCveModalidad=?, iCveSolicitante=?, iCveRepLegal=?, cNomAutorizaRecoger=?, iCveUsuRegistra=?, tsRegistro=?, dtLimiteEntregaDocs=?, dtEstimadaEntrega=?, lPagado=?, dtEntrega=?, iCveUsuEntrega=?, lResolucionPositiva=?, lDatosPreregistro=?, iIdBien=?, iCveOficina=?, iCveDepartamento=?, iEjercicioCita=?, iIdCita=?, iCveForma=?, lPrincipal=?, lImpreso=?, iCveDomicilioSolicitante=?, iCveDomicilioRepLegal=? where iEjercicio = ? AND iNumSolicitud = ?  </b></p>
   * <p><b> Campos Llave: iEjercicio,iNumSolicitud, </b></p>
   * @param vData TVDinRep      - VO Dinámico que contiene a la entidad a Insertar.
   * @param cnNested Connection - Conexión anidada que permite que el método se encuentre dentro de una transacción mayor.
   * @throws DAOException       - Excepción de tipo DAO
  ...
  public TVDinRep update(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      String lSQL = "update TRARegSolicitud set iCveTramite=?, iCveModalidad=?, iCveSolicitante=?, iCveRepLegal=?, cNomAutorizaRecoger=?, iCveUsuRegistra=?, tsRegistro=?, dtLimiteEntregaDocs=?, dtEstimadaEntrega=?, lPagado=?, dtEntrega=?, iCveUsuEntrega=?, lResolucionPositiva=?, lDatosPreregistro=?, iIdBien=?, iCveOficina=?, iCveDepartamento=?, iEjercicioCita=?, iIdCita=?, iCveForma=?, lPrincipal=?, lImpreso=?, iCveDomicilioSolicitante=?, iCveDomicilioRepLegal=? where iEjercicio = ? AND iNumSolicitud = ? ";
      ...
      lPStmt.setInt(22,vData.getInt("lImpreso"));
      lPStmt.setInt(23,vData.getInt("iCveDomicilioSolicitante"));
      lPStmt.setInt(24,vData.getInt("iCveDomicilioRepLegal"));
      lPStmt.setInt(25,vData.getInt("iEjercicio"));
      lPStmt.setInt(26,vData.getInt("iNumSolicitud"));
      lPStmt.executeUpdate();
      if(cnNested == null){
        conn.commit();
      }
