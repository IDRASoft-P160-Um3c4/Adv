...
public class TDIngresos extends DAOBase {
  ...
  /**
   * Método que busca todas las Tarifas
   ...
   * @return Colección de Tarifas encontrados.
   */
  ...
  /**
   * Método que genera un movimiento
  ...
  /**
   * Método que inserta un registro de usuario
   * @param cRPA Dato RPA.
   * @param cRFC Dato RFC.
...
public Object insertUsr(TVDinRep vdDatosSol) {
  ...
  /**
   * Método que busca un usuario en base al RFC, CURP, RPA
   * @param cValor Cadena conel valor por el cual se va a realizar la búsqueda (RFC, CURP, RPA).
   * @param iTipoBusqueda Por qué se va a realizar la búsqueda, 1 por RFC, 2 por CURP, 3 por RPA.
  ...
  /**
   * Método que busca un usuario en base a su clave
