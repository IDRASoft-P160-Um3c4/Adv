...
public class TDRGSUbicacion
  ...
  public TVDinRep insert(TVDinRep vData, Connection cnNested) throws
    ...
    try{
      ...
      System.out.println("...senal.." + vData.getInt("iCveSenal"));
      lPStmt.setInt(1, vData.getInt("iCveSenal"));
      System.out.println("...fecha.." + vData.getDate("dtIniUbicacion"));
      lPStmt.setDate(2, vData.getDate("dtIniUbicacion"));
      System.out.println("...latitug.." + vData.getInt("iGradosLatitud"));
  ...
  public TVDinRep update(TVDinRep vData, Connection cnNested) throws
    ...
    try{
      ...
      System.out.println("*****    dSegundosLongitud "+vData.getDouble("dSegundosLongitud"));
      System.out.println("*****    dSegundosLatitud "+vData.getDouble("dSegundosLatitud"));
