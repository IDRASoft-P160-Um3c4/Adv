 ...
 * @version 1.0
 */
public class TDGRLDomicilio extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      //AGREGAR AL ULTIMO ...
      /*Vector vcData = findByCustom("","select MAX(iCveDomicilio) AS iCveDomicilio from GRLDomicilio where iCvePersona=" +vData.getInt("iCvePersona") );
      if(vcData.size() > 0){
         TVDinRep vUltimo = (TVDinRep) vcData.get(0);
         vData.put("iCveDomicilio",vUltimo.getInt("iCveDomicilio") + 1);
      }else
         vData.put("iCveDomicilio",1);*/
      vData.addPK(vData.getString("iCvePersona"));
      vData.addPK(vData.getString("iCveDomicilio"));
      //...
 System.out.println("iCvePersona" + vData.getInt("iCvePersona"));
      ...
      System.out.println("pais" + vData.getInt("iCvePais"));
