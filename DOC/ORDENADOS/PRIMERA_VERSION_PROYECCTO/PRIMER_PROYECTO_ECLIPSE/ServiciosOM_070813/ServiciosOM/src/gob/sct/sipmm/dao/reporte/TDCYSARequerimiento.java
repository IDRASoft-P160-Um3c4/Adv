...
public class TDCYSARequerimiento
extends DAOBase{
	...
	public TDCYSARequerimiento(){
	}

	public StringBuffer requerimiento(String cQuery,String cNumFolio,
...
//		Encabezado
		...
		rep.comDespliegaAlineado("I",iReng,"N",iReng,"Asunto: Requerimiento",true,rep.getAT_HIZQUIERDA(),rep.getAT_VSUPERIOR());
		iReng+=2;
