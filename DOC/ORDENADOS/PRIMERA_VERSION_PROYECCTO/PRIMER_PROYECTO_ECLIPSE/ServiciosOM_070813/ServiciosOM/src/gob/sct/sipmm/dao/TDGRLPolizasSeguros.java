...
public class TDGRLPolizasSeguros extends DAOBase{
  ...
  public TVDinRep insert(TVDinRep vData,Connection cnNested) throws
    ...
    try{
      ...
      System.out.println("*****    Asegurado =>> " + vData.getString("cNomAsegurado"));
      ...
      System.out.println("*****     Poliza:       "+vData.getInt("iCvePoliza"));
      System.out.println("*****     Aseguradora:  "+vData.getInt("iCveAseguradora"));
      System.out.println("*****     NumPoliza:    "+vData.getString("cNumPoliza"));
      System.out.println("*****     dtInicio:     "+vData.getDate("dtInicioVigencia"));
      System.out.println("*****     dtFin:        "+vData.getDate("dtFinVigencia"));
      System.out.println("*****     Asegurado:    "+vData.getString("cNomAsegurado"));
      System.out.println("*****     TipoVehiculo: "+vData.getInt("iCveTipoVehiculo"));
      System.out.println("*****     ObjetoPoli:   "+vData.getInt("iObjetoPoliza"));
      System.out.println("*****     Ejercicio:    "+vObses.getInt("IEjercicioObsLarga"));
      System.out.println("*****     Observacion:  "+vObses.getInt("iCveObsLarga"));
