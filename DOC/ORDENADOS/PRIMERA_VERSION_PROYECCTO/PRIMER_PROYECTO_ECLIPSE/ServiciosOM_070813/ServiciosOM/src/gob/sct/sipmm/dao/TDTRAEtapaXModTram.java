...
public class TDTRAEtapaXModTram extends DAOBase{
 ...
 public TVDinRep Abajo(TVDinRep vData,Connection cnNested) throws
   ...
   try{
     ...
     System.out.println("*****  Abajo     *****  Tramite, modalidad, Etapa, OrdenI, OrdenF          "+vData.getInt("iCveTramite")+", "+vData.getInt("iCveModalidad")+", "+vData.getInt("iCveEtapa")+", "+vData.getInt("iEtapaTemp"));
